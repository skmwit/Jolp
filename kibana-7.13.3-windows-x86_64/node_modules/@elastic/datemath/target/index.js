...
exports.parse = exports.unitsAsc = exports.unitsDesc = exports.units = exports.unitsMap = void 0;
...
exports.units = Object.keys(exports.unitsMap).sort((a, b) => exports.unitsMap[b].weight - exports.unitsMap[a].weight);
exports.unitsDesc = [...exports.units];
exports.unitsAsc = [...exports.units].reverse();
...
function parse(input, options = {}) {
    const text = input;
    const { roundUp = false, momentInstance = moment_1.default, forceNow } = options;
    if (!text)
        return undefined;
    if (momentInstance.isMoment(text))
        return text;
    if (isDate(text))
        return momentInstance(text);
...
function parseDateMath(mathString, time, roundUp) {
    ...
    while (i < len) {
        ...
        if (exports.units.indexOf(unit) === -1) {
            return;
        }
        else {
            if (type === 0) {
...
exports.default = {
    parse,
    unitsMap: Object.freeze(exports.unitsMap),
    units: Object.freeze(exports.units),
    unitsAsc: Object.freeze(exports.unitsAsc),
    unitsDesc: Object.freeze(exports.unitsDesc),
};
