...
var EuiCommentList = function EuiCommentList(_ref) {
  ...
  if (comments) {
    commentElements = comments.map(function (item, index) {
      return /*#__PURE__*/_react.default.createElement(_comment.EuiComment, _extends({
        key: index
      }, item));
    });
  }
...
EuiCommentList.propTypes = {
  ...
  comments: _propTypes.default.arrayOf(_propTypes.default.shape({
    ...
    /**
       ...
       */
    type: _propTypes.default.oneOfType([_propTypes.default.oneOf(["regular", "update"]), _propTypes.default.oneOf(["regular", "update"])]),
