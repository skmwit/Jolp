...
var EuiDataGridCellContent = /*#__PURE__*/(0, _react.memo)(function (props) {
  ...
  return /*#__PURE__*/_react.default.createElement(CellElement, _extends({
    isDetails: false,
...
var EuiDataGridCell = /*#__PURE__*/function (_Component) {
  ...
  function EuiDataGridCell() {
    ...
    _defineProperty(_assertThisInitialized(_this), "cellRef", /*#__PURE__*/(0, _react.createRef)());

    _defineProperty(_assertThisInitialized(_this), "observer", void 0);

    _defineProperty(_assertThisInitialized(_this), "popoverPanelRef", /*#__PURE__*/(0, _react.createRef)());
    ...
    _defineProperty(_assertThisInitialized(_this), "setCellRef", function (ref) {
      _this.cellRef.current = ref; // watch the first cell for size changes and use that to re-compute row heights

      if (_this.props.colIndex === 0 && _this.props.visibleRowIndex === 0) {
        if (ref && hasResizeObserver) {
          _this.observer = new window.ResizeObserver(function () {
            var rowHeight = _this.cellRef.current.getBoundingClientRect().height;

            if (_this.props.setRowHeight) {
              _this.props.setRowHeight(rowHeight);
            }
          });

          _this.observer.observe(ref);
    ...
    _defineProperty(_assertThisInitialized(_this), "takeFocus", function () {
  ...
  _createClass(EuiDataGridCell, [{
    ...
    value: function componentDidMount() {
      this.unsubscribeCell = this.context.onFocusUpdate([this.props.colIndex, this.props.visibleRowIndex], this.onFocusUpdate);
    }
  }, {
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      ...
      if (nextProps.popoverContent !== this.props.popoverContent) return true; // respond to adjusted top/left
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          ...
          rest = _objectWithoutProperties(_this$props2, ["width", "isExpandable", "popoverContent", "interactiveCellId", "columnType", "className", "column", "style"]);
      ...
      var cellClasses = (0, _classnames.default)('euiDataGridRowCell', (_classNames = {}, _defineProperty(_classNames, "euiDataGridRowCell--".concat(columnType), columnType), _defineProperty(_classNames, 'euiDataGridRowCell--open', this.state.popoverIsOpen), _classNames), className);
      ...
      var screenReaderPosition = /*#__PURE__*/_react.default.createElement(_accessibility.EuiScreenReaderOnly, null, /*#__PURE__*/_react.default.createElement("p", null, /*#__PURE__*/_react.default.createElement(_i18n.EuiI18n, {
        ...
        return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, row, ": ", rowIndex + 1, ", ", column, ": ", colIndex + 1, ":");
      })));
      ...
      if (isExpandable || column && column.cellActions) {
        if (showCellButtons) {
          anchorContent = /*#__PURE__*/_react.default.createElement("div", {
            ...
            ref: this.setCellContentsRef,
            className: "euiDataGridRowCell__truncate"
          }, /*#__PURE__*/_react.default.createElement(EuiDataGridCellContent, cellContentProps)), screenReaderPosition), showCellButtons && /*#__PURE__*/_react.default.createElement(_data_grid_cell_buttons.EuiDataGridCellButtons, {
            rowIndex: rowIndex,
            column: column,
            ...
            onExpandClick: function onExpandClick() {
              _this2.setState(function (_ref4) {
                var popoverIsOpen = _ref4.popoverIsOpen;
                return {
          ...
          anchorContent = /*#__PURE__*/_react.default.createElement("div", {
            ref: this.setCellContentsRef,
            className: "euiDataGridRowCell__truncate"
          }, /*#__PURE__*/_react.default.createElement(EuiDataGridCellContent, cellContentProps), screenReaderPosition);
        }
      }
      ...
      if (isExpandable || column && column.cellActions) {
        if (this.state.popoverIsOpen) {
          ...
          }, /*#__PURE__*/_react.default.createElement(_data_grid_cell_popover.EuiDataGridCellPopover, {
...
_defineProperty(EuiDataGridCell, "contextType", _data_grid_context.DataGridFocusContext);
