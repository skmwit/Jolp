...
exports.EuiDataGridBody = exports.VIRTUALIZED_CONTAINER_CLASS = void 0;
...
var VIRTUALIZED_CONTAINER_CLASS = 'euiDataGrid__virtualized';
exports.VIRTUALIZED_CONTAINER_CLASS = VIRTUALIZED_CONTAINER_CLASS;
...
var providedPopoverContents = {
  json: function json(_ref) {
    ...
    return /*#__PURE__*/_react.default.createElement(_code.EuiCodeBlock, {
      isCopyable: true,
...
var DefaultColumnFormatter = function DefaultColumnFormatter(_ref2) {
...
var Cell = function Cell(_ref3) {
  var columnIndex = _ref3.columnIndex,
      visibleRowIndex = _ref3.rowIndex,
      style = _ref3.style,
      data = _ref3.data;
  var rowMap = data.rowMap,
      rowOffset = data.rowOffset,
      leadingControlColumns = data.leadingControlColumns,
  ...
  var _useContext = (0, _react.useContext)(_data_grid_context.DataGridWrapperRowsContext),
      headerRowHeight = _useContext.headerRowHeight;

  var offsetRowIndex = visibleRowIndex + rowOffset;
  var rowIndex = rowMap.hasOwnProperty(offsetRowIndex) ? rowMap[offsetRowIndex] : offsetRowIndex;
  var cellContent;
  var isFirstColumn = columnIndex === 0;
  var isLastColumn = columnIndex === columns.length + leadingControlColumns.length + trailingControlColumns.length - 1;
  var isStripableRow = rowIndex % 2 !== 0;
  ...
  if (isLeadingControlColumn) {
    ...
    cellContent = /*#__PURE__*/_react.default.createElement(_data_grid_cell.EuiDataGridCell, {
      rowIndex: rowIndex,
    ...
    var _columnId = column.id;
    var columnType = schema[_columnId] ? schema[_columnId].columnType : null;
    ...
    var _width = columnWidths[_columnId] || defaultColumnWidth;
...
var InnerElement = /*#__PURE__*/(0, _react.forwardRef)(function (_ref4, ref) {
  var children = _ref4.children,
      style = _ref4.style,
      rest = _objectWithoutProperties(_ref4, ["children", "style"]);

  var _useContext2 = (0, _react.useContext)(_data_grid_context.DataGridWrapperRowsContext),
...
var EuiDataGridBody = function EuiDataGridBody(props) {
  ...
  var sorting = (0, _react.useContext)(_data_grid_context.DataGridSortingContext);
  var rowMap = (0, _react.useMemo)(function () {
    ...
    if ((inMemory === null || inMemory === void 0 ? void 0 : inMemory.level) === 'sorting' && sorting != null && sorting.columns.length > 0) {
      ...
      wrappedValues.sort(function (a, b) {
        for (var _i2 = 0; _i2 < sorting.columns.length; _i2++) {
          var column = sorting.columns[_i2];
          ...
          if (schema.hasOwnProperty(column.id)) {
            ...
            for (var _i3 = 0; _i3 < schemaDetectors.length; _i3++) {
              var detector = schemaDetectors[_i3];
      ...
      for (var _i4 = 0; _i4 < wrappedValues.length; _i4++) {
        rowMap[_i4] = wrappedValues[_i4].index;
      }
    }

    return rowMap;
  }, [sorting, inMemoryValues, schema, schemaDetectors, inMemory === null || inMemory === void 0 ? void 0 : inMemory.level]);
  ...
  var headerRow = (0, _react.useMemo)(function () {
    return /*#__PURE__*/_react.default.createElement(_data_grid_header_row.EuiDataGridHeaderRow, {
      ref: setHeaderRowRef,
  ...
  var footerRow = (0, _react.useMemo)(function () {
    ...
    return /*#__PURE__*/_react.default.createElement(_data_grid_footer_row.EuiDataGridFooterRow, {
      ref: setFooterRowRef,
      leadingControlColumns: leadingControlColumns,
      trailingControlColumns: trailingControlColumns,
      columns: columns,
  ...
  }, [columnWidths, columns, defaultColumnWidth, interactiveCellId, leadingControlColumns, mergedPopoverContents, renderFooterCellValue, schema, trailingControlColumns, visibleRowIndices.length]);
  ...
  var getWidth = (0, _react.useCallback)(function (index) {
    ...
    return columnWidths[columns[index - leadingControlColumns.length].id] || defaultColumnWidth || 100;
  }, [leadingControlColumns, columns, columnWidths, defaultColumnWidth, trailingControlColumns]);

  var _useState5 = (0, _react.useState)(INITIAL_ROW_HEIGHT),
      _useState6 = _slicedToArray(_useState5, 2),
      rowHeight = _useState6[0],
      setRowHeight = _useState6[1];

  var getRowHeight = (0, _react.useCallback)(function () {
    return rowHeight;
  }, [rowHeight]);
  (0, _react.useEffect)(function () {
    if (gridRef.current) gridRef.current.resetAfterRowIndex(0);
  }, [getRowHeight]);
  var rowCountToAffordFor = pagination ? pagination.pageSize : visibleRowIndices.length;
  var unconstrainedHeight = rowHeight * rowCountToAffordFor + headerRowHeight + footerRowHeight; // unable to determine this until the container's size is known anyway

  var unconstrainedWidth = 0;
  ...
  var wrapperDimensions = (0, _resize_observer.useResizeObserver)(wrapperRef.current); // reset height constraint when rowCount changes
  ...
  var preventTabbing = (0, _react.useCallback)(function () {
    if (wrapperRef.current) {
      var tabbables = (0, _tabbable.default)(wrapperRef.current);
  ...
  var finalHeight = IS_JEST_ENVIRONMENT ? Number.MAX_SAFE_INTEGER : height || unconstrainedHeight;
  var finalWidth = IS_JEST_ENVIRONMENT ? Number.MAX_SAFE_INTEGER : width || unconstrainedWidth;
  ...
  return /*#__PURE__*/_react.default.createElement(_mutation_observer.EuiMutationObserver, {
    observerOptions: {
      subtree: true,
      childList: true
    },
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
    ...
    }, (IS_JEST_ENVIRONMENT || finalWidth > 0) && /*#__PURE__*/_react.default.createElement(_data_grid_context.DataGridWrapperRowsContext.Provider, {
      value: {
      ...
      columnCount: leadingControlColumns.length + columns.length + trailingControlColumns.length,
      width: finalWidth,
      ...
      rowCount: IS_JEST_ENVIRONMENT || headerRowHeight > 0 ? visibleRowIndices.length : 0
    }, Cell)));
  });
};
...
EuiDataGridBody.propTypes = {
  ...
  toolbarHeight: _propTypes.default.number.isRequired
};