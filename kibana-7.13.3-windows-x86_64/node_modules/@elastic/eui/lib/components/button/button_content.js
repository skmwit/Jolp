...
var EuiButtonContent = function EuiButtonContent(_ref) {
  var children = _ref.children,
      ...
      contentProps = _objectWithoutProperties(_ref, ["children", "textProps", "isLoading", "iconType", "iconSide"]);

  // Add an icon to the button if one exists.
  var buttonIcon;

  if (isLoading) {
    buttonIcon = /*#__PURE__*/_react.default.createElement(_loading.EuiLoadingSpinner, {
  ...
  return /*#__PURE__*/_react.default.createElement("span", _extends({}, contentProps, {
    className: contentClassNames
  }), buttonIcon, /*#__PURE__*/_react.default.createElement("span", textProps, children));
};
