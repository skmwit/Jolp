...
var EuiEmptyPrompt = function EuiEmptyPrompt(_ref) {
  var iconType = _ref.iconType,
      ...
      iconColor = _ref$iconColor === void 0 ? 'subdued' : _ref$iconColor,
      title = _ref.title,
  ...
  if (iconType) {
    icon = /*#__PURE__*/_react.default.createElement(_react.Fragment, null, /*#__PURE__*/_react.default.createElement(_icon.EuiIcon, {
      type: iconType,
      size: "xxl",
      color: iconColor
  ...
  if (body || title) {
    ...
    if (title) {
      titleEl = /*#__PURE__*/_react.default.createElement(_react.Fragment, null, /*#__PURE__*/_react.default.createElement(_title.EuiTitle, {
        size: titleSize
      }, title), /*#__PURE__*/_react.default.createElement(_spacer.EuiSpacer, {
        size: "m"
      }));
    }
    ...
    if (body) {
      bodyEl = /*#__PURE__*/_react.default.createElement(_react.Fragment, null, /*#__PURE__*/_react.default.createElement(_text.EuiText, null, body));
    }

    content = /*#__PURE__*/_react.default.createElement(_text.EuiTextColor, {
      color: "subdued"
    }, titleEl, bodyEl);
  }
  ...
  if (actions) {
    ...
    if (Array.isArray(actions)) {
      actionsRow = /*#__PURE__*/_react.default.createElement(_flex.EuiFlexGroup, {
        gutterSize: "m",
        alignItems: "center",
    ...
    actionsEl = /*#__PURE__*/_react.default.createElement(_react.Fragment, null, /*#__PURE__*/_react.default.createElement(_spacer.EuiSpacer, {
      size: "s"
    }), actionsRow);
  }
  ...
  return /*#__PURE__*/_react.default.createElement("div", _extends({
    className: classes
  }, rest), icon, content, body && actions && /*#__PURE__*/_react.default.createElement(_spacer.EuiSpacer, {
    size: "l"
  }), actionsEl);
};
...
EuiEmptyPrompt.propTypes = {
  ...
  iconColor: _propTypes.default.oneOfType([_propTypes.default.string.isRequired, _propTypes.default.oneOf(["default", "primary", "secondary", "success", "accent", "warning", "danger", "text", "subdued", "ghost"]).isRequired]),
