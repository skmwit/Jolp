...
var hitEnterBadge = /*#__PURE__*/_react.default.createElement(_badge.EuiBadge, {
...
var EuiComboBoxOptionsList = /*#__PURE__*/function (_Component) {
    ...
    _defineProperty(_assertThisInitialized(_this), "ListRow", function (_ref) {
      ...
      if (isGroupLabelOption) {
        return /*#__PURE__*/_react.default.createElement("div", {
          ...
          style: style
        }, /*#__PURE__*/_react.default.createElement(_combo_box_title.EuiComboBoxTitle, null, label));
      }
      ...
      return /*#__PURE__*/_react.default.createElement(_filter_select_item.EuiFilterSelectItem, _extends({
        style: style,
      ...
      }, renderOption ? /*#__PURE__*/_react.default.createElement("span", {
        className: OPTION_CONTENT_CLASSNAME
      }, renderOption(option, searchValue, 'euiComboBoxOption__renderOption')) : /*#__PURE__*/_react.default.createElement(_highlight.EuiHighlight, {
        search: searchValue,
        className: OPTION_CONTENT_CLASSNAME
  ...
  _createClass(EuiComboBoxOptionsList, [{
    ...
    value: function render() {
      ...
      if (isLoading) {
        emptyStateContent = /*#__PURE__*/_react.default.createElement(_flex.EuiFlexGroup, {
          gutterSize: "s",
        ...
        if (onCreateOption && getSelectedOptionForSearchValue) {
          if (delimiter && searchValue.includes(delimiter)) {
            emptyStateContent = /*#__PURE__*/_react.default.createElement("div", {
              className: "euiComboBoxOption__contentWrapper"
              ...
              values: {
                delimiter: /*#__PURE__*/_react.default.createElement("strong", null, delimiter)
              }
            })), hitEnterBadge);
          } else {
            ...
            if (selectedOptionForValue) {
              ...
              emptyStateContent = /*#__PURE__*/_react.default.createElement("p", null, /*#__PURE__*/_react.default.createElement(_i18n.EuiI18n, {
                token: "euiComboBoxOptionsList.alreadyAdded",
                default: "{label} has already been added",
                values: {
                  label: /*#__PURE__*/_react.default.createElement("strong", null, selectedOptionForValue.label)
                }
              }));
            } else {
              var highlightSearchValue = function highlightSearchValue(text, searchValue) {
                ...
                return /*#__PURE__*/_react.default.createElement("p", {
                  ...
                  return part.match(reg) ? /*#__PURE__*/_react.default.createElement("strong", {
                    key: idx
                  }, searchValue) : part;
                }));
              };
              ...
              emptyStateContent = /*#__PURE__*/_react.default.createElement("div", {
                className: "euiComboBoxOption__contentWrapper"
              }, customOptionText ? highlightSearchValue(customOptionText, searchValue) : /*#__PURE__*/_react.default.createElement("p", {
                className: "euiComboBoxOption__emptyStateText"
              }, /*#__PURE__*/_react.default.createElement(_i18n.EuiI18n, {
      ...
      var emptyState = emptyStateContent ? /*#__PURE__*/_react.default.createElement(_text.EuiText, {
        size: "xs",
      ...
      var optionsList = /*#__PURE__*/_react.default.createElement(_reactWindow.FixedSizeList, {
