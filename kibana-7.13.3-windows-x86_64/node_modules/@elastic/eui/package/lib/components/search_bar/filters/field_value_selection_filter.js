...
var FieldValueSelectionFilter = /*#__PURE__*/function (_Component) {
  ...
  _createClass(FieldValueSelectionFilter, [{
    ...
    value: function render() {
      ...
      var button = /*#__PURE__*/_react.default.createElement(_filter_group.EuiFilterButton, {
        iconType: "arrowDown",
        iconSide: "right",
    ...
    value: function renderSearchBox() {
      ...
      if (this.state.options && this.state.options.all.length >= threshold) {
        ...
        return /*#__PURE__*/_react.default.createElement(_popover.EuiPopoverTitle, {
          paddingSize: "s"
        }, /*#__PURE__*/_react.default.createElement(_field_search.EuiFieldSearch, {
    ...
    value: function renderContent(field, query, config, multiSelect) {
      ...
      this.state.options.shown.forEach(function (option, index) {
        ...
        var item = /*#__PURE__*/_react.default.createElement(_filter_group.EuiFilterSelectItem, {
          key: index,
          checked: checked,
          onClick: onClick,
    ...
    value: function renderLoader() {
      ...
      }, /*#__PURE__*/_react.default.createElement(_loading.EuiLoadingChart, {
        size: "m"
