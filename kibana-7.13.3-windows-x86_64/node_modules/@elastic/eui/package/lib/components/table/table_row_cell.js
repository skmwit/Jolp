...
var EuiTableRowCell = function EuiTableRowCell(_ref) {
  ...
  function modifyChildren(children) {
    ...
    if (textOnly === true) {
      modifiedChildren = /*#__PURE__*/_react.default.createElement("span", {
  ...
  if (mobileOptions.show === false || hideForMobile) {
    ...
    }, sharedProps), /*#__PURE__*/_react.default.createElement("div", {
      className: contentClasses
    }, childrenNode));
  } else {
    return /*#__PURE__*/_react.default.createElement(Element, _extends({
      className: cellClasses
    }, sharedProps), (mobileOptions.header || header) && !isMobileHeader && /*#__PURE__*/_react.default.createElement("div", {
      className: "euiTableRowCell__mobileHeader ".concat(showForMobileClasses)
    }, mobileOptions.header || header), mobileOptions.render ? /*#__PURE__*/_react.default.createElement(_react.Fragment, null, /*#__PURE__*/_react.default.createElement("div", {
      className: "".concat(mobileContentClasses, " ").concat(showForMobileClasses)
    }, modifyChildren(mobileOptions.render)), /*#__PURE__*/_react.default.createElement("div", {
      className: "".concat(contentClasses, " ").concat(hideForMobileClasses)
    }, childrenNode)) : /*#__PURE__*/_react.default.createElement("div", {
      className: contentClasses
    }, childrenNode));
  }
};
