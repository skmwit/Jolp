...
var EuiTableSortMobile = /*#__PURE__*/function (_Component) {
  ...
  _createClass(EuiTableSortMobile, [{
    ...
    value: function render() {
      ...
      var mobileSortButton = /*#__PURE__*/_react.default.createElement(_button_empty.EuiButtonEmpty, {
        iconType: "arrowDown",
        iconSide: "right",
      ...
      var mobileSortPopover = /*#__PURE__*/_react.default.createElement(_popover.EuiPopover, _extends({
        button: mobileSortButton,
        isOpen: this.state.isPopoverOpen,
        closePopover: this.closePopover,
        anchorPosition: anchorPosition || 'downRight',
        panelPaddingSize: "none"
      }, rest), /*#__PURE__*/_react.default.createElement(_context_menu.EuiContextMenuPanel, {
        style: {
          minWidth: 200
        },
        items: items && items.length ? items.map(function (item) {
          return /*#__PURE__*/_react.default.createElement(_table_sort_mobile_item.EuiTableSortMobileItem, {
            key: item.key,
            onSort: item.onSort,
