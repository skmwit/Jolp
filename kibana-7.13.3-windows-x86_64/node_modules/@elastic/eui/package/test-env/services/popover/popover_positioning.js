...
var getBufferValues = function getBufferValues(buffer) {
  if (Array.isArray(buffer)) {
    var _buffer = (0, _slicedToArray2.default)(buffer, 4),
        topBuffer = _buffer[0],
...
function getPopoverScreenCoordinates(_ref2) {
  ...
  var _getBufferValues = getBufferValues(buffer),
      _getBufferValues2 = (0, _slicedToArray2.default)(_getBufferValues, 4),
  ...
  var popoverPlacement = (_popoverPlacement = {}, (0, _defineProperty2.default)(_popoverPlacement, crossAxisFirstSide, crossAxisPosition), (0, _defineProperty2.default)(_popoverPlacement, primaryAxisPositionName, primaryAxisPosition), _popoverPlacement); // calculate the fit of the popover in this location
  ...
  var arrow = arrowConfig ? (_ref3 = {}, (0, _defineProperty2.default)(_ref3, crossAxisFirstSide, crossAxisArrowPosition - popoverPlacement[crossAxisFirstSide]), (0, _defineProperty2.default)(_ref3, primaryAxisPositionName, primaryAxisArrowPosition), _ref3) : undefined;
  return {
    fit: fit,
    top: popoverPlacement.top,
    left: popoverPlacement.left,
...
function getAvailableSpace(anchorBoundingBox, containerBoundingBox, buffer, offset, offsetSide) {
  var _getBufferValues3 = getBufferValues(buffer),
      _getBufferValues4 = (0, _slicedToArray2.default)(_getBufferValues3, 4),
