...
function getRangeMin(colorStops, min) {
  ...
  var first = Math.min.apply(Math, (0, _toConsumableArray2.default)(stops)); // https://johnresig.com/blog/fast-javascript-maxmin/
...
function getRangeMax(colorStops, max) {
  ...
  var stops = getValidStops(colorStops);
  var last = Math.max.apply(Math, (0, _toConsumableArray2.default)(stops)); // https://johnresig.com/blog/fast-javascript-maxmin/
...
var EuiColorStops = function EuiColorStops(_ref) {
  ...
  var thumbs = (0, _react.useMemo)(function () {
    var handleStopChange = function handleStopChange(stop, id) {
      var newColorStops = (0, _toConsumableArray2.default)(colorStops);
