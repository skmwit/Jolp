...
var EuiFlyout = function EuiFlyout(_ref) {
  var className = _ref.className,
      ...
      rest = (0, _objectWithoutProperties2.default)(_ref, ["className", "children", "hideCloseButton", "onClose", "ownFocus", "size", "paddingSize", "closeButtonAriaLabel", "maxWidth", "style", "maskProps"]);
  ...
  var flyoutContent = /*#__PURE__*/_react.default.createElement("div", (0, _extends2.default)({
    role: "dialog",
    className: classes,
    tabIndex: 0,
  ...
  if (ownFocus) {
    optionalOverlay = /*#__PURE__*/_react.default.createElement(_overlay_mask.EuiOverlayMask, (0, _extends2.default)({
      onClick: onClose,
