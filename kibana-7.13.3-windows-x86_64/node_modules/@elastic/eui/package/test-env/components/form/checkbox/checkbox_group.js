...
var EuiCheckboxGroup = function EuiCheckboxGroup(_ref) {
  ...
  var checkboxes = options.map(function (option, index) {
    ...
    return /*#__PURE__*/_react.default.createElement(_checkbox.EuiCheckbox, (0, _extends2.default)({
  ...
  if (!!legend) {
    ...
    return /*#__PURE__*/_react.default.createElement(_form_fieldset.EuiFormFieldset, (0, _extends2.default)({
      className: className,
      legend: legend
    }, rest), checkboxes);
  }
