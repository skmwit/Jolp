...
export var EuiListGroupItem = function EuiListGroupItem(_ref) {
  ...
  if (iconType) {
    iconNode = /*#__PURE__*/React.createElement(EuiIcon, _extends({
  ...
  if (extraAction) {
    ...
    extraActionNode = /*#__PURE__*/React.createElement(EuiButtonIcon, _extends({
  ...
  var labelContent = shouldRenderTitle ? /*#__PURE__*/React.createElement("span", {
    ref: ref,
  ...
  if (href && !isDisabled) {
    itemContent = /*#__PURE__*/React.createElement("a", _extends({
    ...
    itemContent = /*#__PURE__*/React.createElement("button", _extends({
      type: "button",
      className: "euiListGroupItem__button",
      disabled: isDisabled,
      onClick: onClick,
    ...
    itemContent = /*#__PURE__*/React.createElement("span", _extends({
      className: "euiListGroupItem__text"
    }, rest), iconNode, labelContent);
  }

  if (showToolTip) {
    itemContent = /*#__PURE__*/React.createElement("li", {
      className: classes
  ...
  return /*#__PURE__*/React.createElement(Fragment, null, itemContent);
};
