...
export var DefaultItemAction = function DefaultItemAction(_ref) {
  ...
  if (action.type === 'icon') {
    ...
    var ariaLabelId = htmlIdGenerator()();
    button = /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(EuiButtonIcon, {
      className: className,
  ...
  return enabled && action.description ? /*#__PURE__*/React.createElement(EuiToolTip, {
