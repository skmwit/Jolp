...
export var createFilter = function createFilter(index, config, query, onChange) {
  ...
  switch (config.type) {
    case 'is':
      return /*#__PURE__*/React.createElement(IsFilter, _extends({}, props, {
        config: config
      }));

    case 'field_value_selection':
      return /*#__PURE__*/React.createElement(FieldValueSelectionFilter, _extends({}, props, {
        config: config
      }));

    case 'field_value_toggle':
      return /*#__PURE__*/React.createElement(FieldValueToggleFilter, _extends({}, props, {
        config: config
      }));

    case 'field_value_toggle_group':
      return /*#__PURE__*/React.createElement(FieldValueToggleGroupFilter, _extends({}, props, {
        config: config
      }));
