...
export var EuiButtonGroupButton = function EuiButtonGroupButton(_ref) {
  ...
  var newId = useRef(htmlIdGenerator()()).current;
  var elementProps = {};
  var singleInput;
  ...
  if (el === 'label') {
    ...
    singleInput = /*#__PURE__*/React.createElement("input", {
      id: newId,
...
EuiButtonGroupButton.propTypes = {
  ...
  /**
     ...
     */
  color: PropTypes.oneOf(["primary", "secondary", "warning", "danger", "ghost", "text"]).isRequired,
