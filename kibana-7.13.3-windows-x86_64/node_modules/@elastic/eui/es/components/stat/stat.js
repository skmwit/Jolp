...
export var EuiStat = function EuiStat(_ref) {
  ...
  var descriptionDisplay = /*#__PURE__*/React.createElement(EuiText, {
    size: "s",
  ...
  var titleDisplay = isColorClass(titleColor) ? /*#__PURE__*/React.createElement(EuiTitle, {
    size: titleSize,
    className: titleClasses
  }, /*#__PURE__*/createElement(titleElement, commonProps, titleChildren)) : /*#__PURE__*/React.createElement(EuiTitle, {
    size: titleSize,
    className: titleClasses
  }, /*#__PURE__*/createElement(titleElement, titlePropsWithColor, titleChildren));
  var screenReader = /*#__PURE__*/React.createElement(EuiScreenReaderOnly, null, /*#__PURE__*/React.createElement("p", null, isLoading ? /*#__PURE__*/React.createElement(EuiI18n, {
    token: "euiStat.loadingText",
    default: "Statistic is loading"
  }) : /*#__PURE__*/React.createElement(Fragment, null, reverse ? "".concat(title, " ").concat(description) : "".concat(description, " ").concat(title))));
  var statDisplay = /*#__PURE__*/React.createElement(Fragment, null, !reverse && descriptionDisplay, titleDisplay, reverse && descriptionDisplay, typeof title === 'string' && typeof description === 'string' && screenReader);
