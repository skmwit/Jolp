  ...
  function EuiSideNav() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderTree", function (items) {
      ...
      return items.map(function (item) {
        ...
        return /*#__PURE__*/React.createElement(EuiSideNavItem, _extends({
          isOpen: isOpen,
  ...
  _createClass(EuiSideNav, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement("nav", _extends({
        className: classes
      }, rest), /*#__PURE__*/React.createElement(EuiButtonEmpty, {
        className: "euiSideNav__mobileToggle",
        onClick: toggleOpenOnMobile,
        iconType: "apps",
        iconSide: "right"
      }, mobileTitle), /*#__PURE__*/React.createElement("div", {
