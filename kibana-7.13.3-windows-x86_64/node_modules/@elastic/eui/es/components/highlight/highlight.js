...
var highlight = function highlight(searchSubject, searchValue, isStrict, highlightAll) {
  ...
  if (highlightAll) {
    ...
    return /*#__PURE__*/React.createElement(Fragment, null, chunks.map(function (chunk) {
      var end = chunk.end,
      ...
      if (highlight) {
        return /*#__PURE__*/React.createElement(EuiMark, {
          key: start
        }, value);
      }
  ...
  return /*#__PURE__*/React.createElement(Fragment, null, preMatch, /*#__PURE__*/React.createElement(EuiMark, null, match), postMatch);
};
