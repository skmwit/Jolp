...
export var EuiFormRow = /*#__PURE__*/function (_Component) {
  ...
  _createClass(EuiFormRow, [{
    ...
    value: function render() {
      ...
      if (helpText) {
        optionalHelpText = /*#__PURE__*/React.createElement(EuiFormHelpText, {
          id: "".concat(id, "-help"),
      ...
      if (error && isInvalid) {
        ...
        optionalErrors = errorTexts.map(function (error, i) {
          ...
          return /*#__PURE__*/React.createElement(EuiFormErrorText, {
            key: key,
      ...
      if (label || labelAppend) {
        ...
        }, /*#__PURE__*/React.createElement(EuiFormLabel, _extends({
