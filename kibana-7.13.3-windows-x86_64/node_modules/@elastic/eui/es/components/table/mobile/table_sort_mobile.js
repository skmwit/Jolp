...
export var EuiTableSortMobile = /*#__PURE__*/function (_Component) {
  ...
  _createClass(EuiTableSortMobile, [{
    ...
    value: function render() {
      ...
      var mobileSortButton = /*#__PURE__*/React.createElement(EuiButtonEmpty, {
        iconType: "arrowDown",
        iconSide: "right",
      ...
      var mobileSortPopover = /*#__PURE__*/React.createElement(EuiPopover, _extends({
        button: mobileSortButton,
        isOpen: this.state.isPopoverOpen,
        closePopover: this.closePopover,
        anchorPosition: anchorPosition || 'downRight',
        panelPaddingSize: "none"
      }, rest), /*#__PURE__*/React.createElement(EuiContextMenuPanel, {
        style: {
          minWidth: 200
        },
        items: items && items.length ? items.map(function (item) {
          return /*#__PURE__*/React.createElement(EuiTableSortMobileItem, {
            key: item.key,
            onSort: item.onSort,
