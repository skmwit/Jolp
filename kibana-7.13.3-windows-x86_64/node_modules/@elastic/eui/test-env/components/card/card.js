...
var EuiCard = function EuiCard(_ref) {
  var className = _ref.className,
      ...
      rest = (0, _objectWithoutProperties2.default)(_ref, ["className", "description", "isDisabled", "title", "titleElement", "titleSize", "icon", "image", "children", "footer", "onClick", "href", "rel", "target", "textAlign", "betaBadgeLabel", "betaBadgeTooltipContent", "betaBadgeTitle", "layout", "selectable", "display", "paddingSize"]);
  ...
  if (selectable) {
    optionalSelectButton = /*#__PURE__*/_react.default.createElement(_card_select.EuiCardSelect, (0, _extends2.default)({
