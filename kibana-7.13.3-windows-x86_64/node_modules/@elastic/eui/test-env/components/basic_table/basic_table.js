...
var EuiBasicTable = /*#__PURE__*/function (_Component) {
  ...
  (0, _createClass2.default)(EuiBasicTable, [{
    ...
    value: function renderTableHead() {
      ...
      columns.forEach(function (column, index) {
        ...
        if (!column.field) {
          ...
          headers.push( /*#__PURE__*/_react.default.createElement(_table.EuiTableHeaderCell, (0, _extends2.default)({
    ...
    value: function renderItemRow(item, rowIndex) {
      ...
      var row = /*#__PURE__*/_react.default.createElement(_table.EuiTableRow, (0, _extends2.default)({
    ...
    value: function renderItemCell(item, column, key, content, setScopeRow) {
      ...
      return /*#__PURE__*/_react.default.createElement(_table.EuiTableRowCell, (0, _extends2.default)({
        key: key,
        align: columnAlign,
