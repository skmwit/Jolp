...
var EuiCollapsibleNavGroup = function EuiCollapsibleNavGroup(_ref) {
  ...
  var titleContent = title ? /*#__PURE__*/_react.default.createElement(_flex.EuiFlexGroup, {
    ...
    grow: false
  }, /*#__PURE__*/_react.default.createElement(_icon.EuiIcon, (0, _extends2.default)({}, iconProps, {
    type: iconType,
    size: iconSize
  ...
  if (isCollapsible && title) {
    return /*#__PURE__*/_react.default.createElement(_accordion.EuiAccordion, (0, _extends2.default)({
      id: groupID,
      className: classes,
