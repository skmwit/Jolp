...
var EuiRangeTrack = /*#__PURE__*/function (_Component) {
  ...
  (0, _createClass2.default)(EuiRangeTrack, [{
    ...
    value: function render() {
      ...
      }, rest), levels && !!levels.length && /*#__PURE__*/_react.default.createElement(_range_levels.EuiRangeLevels, {
        compressed: compressed,
        levels: levels,
        max: max,
        min: min,
        showTicks: showTicks
      }), tickSequence && /*#__PURE__*/_react.default.createElement(_range_ticks.EuiRangeTicks, {
        disabled: disabled,
        compressed: compressed,
        onChange: onChange,
        ticks: ticks,
