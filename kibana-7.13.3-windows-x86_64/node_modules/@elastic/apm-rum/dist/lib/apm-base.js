...
var ApmBase = function () {
  ...
  _proto.init = function init(config) {
    ...
    if (this.isEnabled() && !this._initialized) {
      ...
      if (isConfigActive) {
        ...
        var flags = (0, _apmRumCore.getInstrumentationFlags)(configService.get('instrument'), configService.get('disableInstrumentations'));
  ...
  _proto.fetchCentralConfig = function fetchCentralConfig() {
    var _this$serviceFactory$2 = this.serviceFactory.getService([_apmRumCore.APM_SERVER, _apmRumCore.LOGGING_SERVICE, _apmRumCore.CONFIG_SERVICE]),
