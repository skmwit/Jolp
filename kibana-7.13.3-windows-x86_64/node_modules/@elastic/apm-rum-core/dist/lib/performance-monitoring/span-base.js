...
var SpanBase = function () {
  function SpanBase(name, type, options) {
    ...
    this.id = options.id || (0, _utils.generateRandomId)(16);
    this.traceId = options.traceId;
    this.sampled = options.sampled;
    this.timestamp = options.timestamp;
    this._start = (0, _utils.getTime)(options.startTime);
    this._end = undefined;
    this.ended = false;
  ...
  _proto.addLabels = function addLabels(tags) {
    ...
    keys.forEach(function (k) {
      return (0, _utils.setLabel)(k, tags[k], ctx.tags);
    });
  };
  ...
  _proto.duration = function duration() {
    return (0, _utils.getDuration)(this._start, this._end);
  };

  return SpanBase;
}();

var _default = SpanBase;
