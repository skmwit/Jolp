 ...
 */.euiSideNavItemButton{font-size:14px;font-size:1rem;line-height:1.71429rem;text-align:left;
  ...
  /* 2 */}.euiSideNavItemButton.euiSideNavItemButton--isClickable:not(:disabled):hover{cursor:pointer}.euiSideNavItemButton.euiSideNavItemButton--isClickable:not(:disabled):focus .euiSideNavItemButton__label,.euiSideNavItemButton.euiSideNavItemButton--isClickable:not(:disabled):hover .euiSideNavItemButton__label{text-decoration:underline
    /* 4 */}.euiSideNavItemButton.euiSideNavItemButton-isSelected{color:#0071c2;font-weight:700}.euiSideNavItemButton.euiSideNavItemButton-isSelected .euiSideNavItemButton__label{text-decoration:underline
      /* 4 */}.euiSideNavItemButton:disabled{cursor:not-allowed;text-decoration:none;color:#abb4c4}.euiSideNavItemButton__content{display:-webkit-flex;display:flex;-webkit-align-items:center;align-items:center}.euiSideNavItemButton__icon{margin-right:8px}.euiSideNavItemButton__labelContainer{min-width:0
...
/**
  ...
  */.euiToastHeader__icon{-webkit-flex:0 0 auto;flex:0 0 auto;fill:#1a1c21;-webkit-transform:translateY(2px);transform:translateY(2px)
  /* 1 */}.euiToastHeader__title{color:#1a1c21;font-size:16px;font-size:1.14286rem;line-height:1.71429rem;overflow-wrap:break-word!important;word-wrap:break-word!important;word-break:break-word;font-weight:300}.euiToastHeader--withBody{margin-bottom:8px}
