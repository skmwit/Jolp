...
class painless_lexer extends Lexer_1.Lexer {
    // tslint:enable:no-trailing-whitespace
    constructor(input) {
        super(input);
        this._interp = new LexerATNSimulator_1.LexerATNSimulator(painless_lexer._ATN, this);
    }
    // @Override
    // @NotNull
    get vocabulary() {
    ...
    // @Override
    get grammarFileName() { return "painless_lexer.g4"; }
    // @Override
    get ruleNames() { return painless_lexer.ruleNames; }
    // @Override
    get serializedATN() { return painless_lexer._serializedATN; }
    // @Override
    get channelNames() { return painless_lexer.channelNames; }
    // @Override
    get modeNames() { return painless_lexer.modeNames; }
    // @Override
    ...
    DIV_sempred(_localctx, predIndex) {
        switch (predIndex) {
            case 0:
    ...
    REGEX_sempred(_localctx, predIndex) {
        switch (predIndex) {
            case 1:
    ...
    static get _ATN() {
        if (!painless_lexer.__ATN) {
            painless_lexer.__ATN = new ATNDeserializer_1.ATNDeserializer().deserialize(Utils.toCharArray(painless_lexer._serializedATN));
        }
        return painless_lexer.__ATN;
    }
}
exports.painless_lexer = painless_lexer;
painless_lexer.WS = 1;
painless_lexer.COMMENT = 2;
painless_lexer.LBRACK = 3;
painless_lexer.RBRACK = 4;
painless_lexer.LBRACE = 5;
painless_lexer.RBRACE = 6;
painless_lexer.LP = 7;
painless_lexer.RP = 8;
painless_lexer.DOT = 9;
painless_lexer.NSDOT = 10;
painless_lexer.COMMA = 11;
painless_lexer.SEMICOLON = 12;
painless_lexer.IF = 13;
painless_lexer.IN = 14;
painless_lexer.ELSE = 15;
painless_lexer.WHILE = 16;
painless_lexer.DO = 17;
painless_lexer.FOR = 18;
painless_lexer.CONTINUE = 19;
painless_lexer.BREAK = 20;
painless_lexer.RETURN = 21;
painless_lexer.NEW = 22;
painless_lexer.TRY = 23;
painless_lexer.CATCH = 24;
painless_lexer.THROW = 25;
painless_lexer.THIS = 26;
painless_lexer.INSTANCEOF = 27;
painless_lexer.BOOLNOT = 28;
painless_lexer.BWNOT = 29;
painless_lexer.MUL = 30;
painless_lexer.DIV = 31;
painless_lexer.REM = 32;
painless_lexer.ADD = 33;
painless_lexer.SUB = 34;
painless_lexer.LSH = 35;
painless_lexer.RSH = 36;
painless_lexer.USH = 37;
painless_lexer.LT = 38;
painless_lexer.LTE = 39;
painless_lexer.GT = 40;
painless_lexer.GTE = 41;
painless_lexer.EQ = 42;
painless_lexer.EQR = 43;
painless_lexer.NE = 44;
painless_lexer.NER = 45;
painless_lexer.BWAND = 46;
painless_lexer.XOR = 47;
painless_lexer.BWOR = 48;
painless_lexer.BOOLAND = 49;
painless_lexer.BOOLOR = 50;
painless_lexer.COND = 51;
painless_lexer.COLON = 52;
painless_lexer.ELVIS = 53;
painless_lexer.REF = 54;
painless_lexer.ARROW = 55;
painless_lexer.FIND = 56;
painless_lexer.MATCH = 57;
painless_lexer.INCR = 58;
painless_lexer.DECR = 59;
painless_lexer.ASSIGN = 60;
painless_lexer.AADD = 61;
painless_lexer.ASUB = 62;
painless_lexer.AMUL = 63;
painless_lexer.ADIV = 64;
painless_lexer.AREM = 65;
painless_lexer.AAND = 66;
painless_lexer.AXOR = 67;
painless_lexer.AOR = 68;
painless_lexer.ALSH = 69;
painless_lexer.ARSH = 70;
painless_lexer.AUSH = 71;
painless_lexer.OCTAL = 72;
painless_lexer.HEX = 73;
painless_lexer.INTEGER = 74;
painless_lexer.DECIMAL = 75;
painless_lexer.STRING = 76;
painless_lexer.REGEX = 77;
painless_lexer.TRUE = 78;
painless_lexer.FALSE = 79;
painless_lexer.NULL = 80;
painless_lexer.PRIMITIVE = 81;
painless_lexer.DEF = 82;
painless_lexer.ID = 83;
painless_lexer.DOTINTEGER = 84;
painless_lexer.DOTID = 85;
painless_lexer.AFTER_DOT = 1;
// tslint:disable:no-trailing-whitespace
painless_lexer.channelNames = [
    "DEFAULT_TOKEN_CHANNEL", "HIDDEN",
];
// tslint:disable:no-trailing-whitespace
painless_lexer.modeNames = [
    "DEFAULT_MODE", "AFTER_DOT",
];
painless_lexer.ruleNames = [
...
painless_lexer._SYMBOLIC_NAMES = [
...
painless_lexer.VOCABULARY = new VocabularyImpl_1.VocabularyImpl(painless_lexer._LITERAL_NAMES, painless_lexer._SYMBOLIC_NAMES, []);
painless_lexer._serializedATNSegments = 2;
painless_lexer._serializedATNSegment0 = "\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x02W\u027A\b\x01" +
...
painless_lexer._serializedATNSegment1 = "\u020E\x03\x02\x02\x02\u020D\u020B\x03\x02\x02\x02\u020E\u0210\x07)\x02" +
...
painless_lexer._serializedATN = Utils.join([
    painless_lexer._serializedATNSegment0,
    painless_lexer._serializedATNSegment1,
], "");
//# sourceMappingURL=painless_lexer.js.map