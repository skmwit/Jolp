...
exports.CastContext = exports.NotContext = exports.PostContext = exports.ReadContext = exports.UnarynotaddsubContext = exports.NotaddsubContext = exports.AddsubContext = exports.PreContext = exports.UnaryContext = exports.AssignmentContext = exports.ConditionalContext = exports.NonconditionalContext = exports.ExpressionContext = exports.ElvisContext = exports.BoolContext = exports.InstanceofContext = exports.CompContext = exports.BinaryContext = exports.SingleContext = exports.NoncondexpressionContext = exports.TrapContext = exports.DeclvarContext = exports.TypeContext = exports.DecltypeContext = exports.DeclarationContext = exports.AfterthoughtContext = exports.InitializerContext = exports.EmptyContext = exports.BlockContext = exports.TrailerContext = exports.ExprContext = exports.ThrowContext = exports.ReturnContext = exports.BreakContext = exports.ContinueContext = exports.DeclContext = exports.DoContext = exports.DstatementContext = exports.TryContext = exports.IneachContext = exports.EachContext = exports.ForContext = exports.WhileContext = exports.IfContext = exports.RstatementContext = exports.StatementContext = exports.ParametersContext = exports.FunctionContext = exports.SourceContext = exports.painless_parser = void 0;
exports.LocalfuncrefContext = exports.ConstructorfuncrefContext = exports.ClassfuncrefContext = exports.FuncrefContext = exports.LamtypeContext = exports.LambdaContext = exports.ArgumentContext = exports.ArgumentsContext = exports.MaptokenContext = exports.MapinitializerContext = exports.ListinitializerContext = exports.NewinitializedarrayContext = exports.NewstandardarrayContext = exports.ArrayinitializerContext = exports.BraceaccessContext = exports.FieldaccessContext = exports.CallinvokeContext = exports.PostdotContext = exports.PostfixContext = exports.NewobjectContext = exports.CalllocalContext = exports.VariableContext = exports.MapinitContext = exports.ListinitContext = exports.RegexContext = exports.StringContext = exports.NullContext = exports.FalseContext = exports.TrueContext = exports.NumericContext = exports.PrecedenceContext = exports.PrimaryContext = exports.NewarrayContext = exports.DynamicContext = exports.ChainContext = exports.RefcasttypeContext = exports.PrimordefcasttypeContext = exports.RefcastContext = exports.PrimordefcastContext = exports.CastexpressionContext = void 0;
...
class painless_parser extends Parser_1.Parser {
    constructor(input) {
        super(input);
        this._interp = new ParserATNSimulator_1.ParserATNSimulator(painless_parser._ATN, this);
    }
    // @Override
    // @NotNull
    get vocabulary() {
    ...
    // @Override
    get grammarFileName() { return "painless_parser.g4"; }
    // @Override
    get ruleNames() { return painless_parser.ruleNames; }
    // @Override
    get serializedATN() { return painless_parser._serializedATN; }
    // @RuleVersion(0)
    source() {
    ...
    // @RuleVersion(0)
    rstatement() {
        let _localctx = new RstatementContext(this._ctx, this.state);
                            ...
                            case 2:
                                {
                                    ...
                                    if (!(this._input.LA(1) != painless_parser.ELSE)) {
                                        throw new FailedPredicateException_1.FailedPredicateException(this, " this._input.LA(1) != painless_parser.ELSE ");
                                    }
                                }
                                break;
                        }
    ...
    // @RuleVersion(0)
    dstatement() {
        let _localctx = new DstatementContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    afterthought() {
        let _localctx = new AfterthoughtContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    decltype() {
        let _localctx = new DecltypeContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    declvar() {
        let _localctx = new DeclvarContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    trap() {
        let _localctx = new TrapContext(this._ctx, this.state);
    ...
    noncondexpression(_p) {
        ...
        let _localctx = new NoncondexpressionContext(this._ctx, _parentState);
    ...
    // @RuleVersion(0)
    unarynotaddsub() {
        let _localctx = new UnarynotaddsubContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    primordefcasttype() {
        let _localctx = new PrimordefcasttypeContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    refcasttype() {
        let _localctx = new RefcasttypeContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    chain() {
        let _localctx = new ChainContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    postdot() {
        let _localctx = new PostdotContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    callinvoke() {
        let _localctx = new CallinvokeContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    braceaccess() {
        let _localctx = new BraceaccessContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    listinitializer() {
        let _localctx = new ListinitializerContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    mapinitializer() {
        let _localctx = new MapinitializerContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    maptoken() {
        let _localctx = new MaptokenContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    lamtype() {
        let _localctx = new LamtypeContext(this._ctx, this.state);
    ...
    // @RuleVersion(0)
    funcref() {
        let _localctx = new FuncrefContext(this._ctx, this.state);
    ...
    sempred(_localctx, ruleIndex, predIndex) {
        switch (ruleIndex) {
            case 4:
                return this.rstatement_sempred(_localctx, predIndex);
            case 16:
                return this.noncondexpression_sempred(_localctx, predIndex);
        }
        return true;
    }
    rstatement_sempred(_localctx, predIndex) {
        switch (predIndex) {
            case 0:
    ...
    noncondexpression_sempred(_localctx, predIndex) {
        switch (predIndex) {
            case 1:
    ...
    static get _ATN() {
        if (!painless_parser.__ATN) {
            painless_parser.__ATN = new ATNDeserializer_1.ATNDeserializer().deserialize(Utils.toCharArray(painless_parser._serializedATN));
        }
        return painless_parser.__ATN;
    }
}
exports.painless_parser = painless_parser;
painless_parser.WS = 1;
painless_parser.COMMENT = 2;
painless_parser.LBRACK = 3;
painless_parser.RBRACK = 4;
painless_parser.LBRACE = 5;
painless_parser.RBRACE = 6;
painless_parser.LP = 7;
painless_parser.RP = 8;
painless_parser.DOT = 9;
painless_parser.NSDOT = 10;
painless_parser.COMMA = 11;
painless_parser.SEMICOLON = 12;
painless_parser.IF = 13;
painless_parser.IN = 14;
painless_parser.ELSE = 15;
painless_parser.WHILE = 16;
painless_parser.DO = 17;
painless_parser.FOR = 18;
painless_parser.CONTINUE = 19;
painless_parser.BREAK = 20;
painless_parser.RETURN = 21;
painless_parser.NEW = 22;
painless_parser.TRY = 23;
painless_parser.CATCH = 24;
painless_parser.THROW = 25;
painless_parser.THIS = 26;
painless_parser.INSTANCEOF = 27;
painless_parser.BOOLNOT = 28;
painless_parser.BWNOT = 29;
painless_parser.MUL = 30;
painless_parser.DIV = 31;
painless_parser.REM = 32;
painless_parser.ADD = 33;
painless_parser.SUB = 34;
painless_parser.LSH = 35;
painless_parser.RSH = 36;
painless_parser.USH = 37;
painless_parser.LT = 38;
painless_parser.LTE = 39;
painless_parser.GT = 40;
painless_parser.GTE = 41;
painless_parser.EQ = 42;
painless_parser.EQR = 43;
painless_parser.NE = 44;
painless_parser.NER = 45;
painless_parser.BWAND = 46;
painless_parser.XOR = 47;
painless_parser.BWOR = 48;
painless_parser.BOOLAND = 49;
painless_parser.BOOLOR = 50;
painless_parser.COND = 51;
painless_parser.COLON = 52;
painless_parser.ELVIS = 53;
painless_parser.REF = 54;
painless_parser.ARROW = 55;
painless_parser.FIND = 56;
painless_parser.MATCH = 57;
painless_parser.INCR = 58;
painless_parser.DECR = 59;
painless_parser.ASSIGN = 60;
painless_parser.AADD = 61;
painless_parser.ASUB = 62;
painless_parser.AMUL = 63;
painless_parser.ADIV = 64;
painless_parser.AREM = 65;
painless_parser.AAND = 66;
painless_parser.AXOR = 67;
painless_parser.AOR = 68;
painless_parser.ALSH = 69;
painless_parser.ARSH = 70;
painless_parser.AUSH = 71;
painless_parser.OCTAL = 72;
painless_parser.HEX = 73;
painless_parser.INTEGER = 74;
painless_parser.DECIMAL = 75;
painless_parser.STRING = 76;
painless_parser.REGEX = 77;
painless_parser.TRUE = 78;
painless_parser.FALSE = 79;
painless_parser.NULL = 80;
painless_parser.PRIMITIVE = 81;
painless_parser.DEF = 82;
painless_parser.ID = 83;
painless_parser.DOTINTEGER = 84;
painless_parser.DOTID = 85;
painless_parser.RULE_source = 0;
painless_parser.RULE_function = 1;
painless_parser.RULE_parameters = 2;
painless_parser.RULE_statement = 3;
painless_parser.RULE_rstatement = 4;
painless_parser.RULE_dstatement = 5;
painless_parser.RULE_trailer = 6;
painless_parser.RULE_block = 7;
painless_parser.RULE_empty = 8;
painless_parser.RULE_initializer = 9;
painless_parser.RULE_afterthought = 10;
painless_parser.RULE_declaration = 11;
painless_parser.RULE_decltype = 12;
painless_parser.RULE_type = 13;
painless_parser.RULE_declvar = 14;
painless_parser.RULE_trap = 15;
painless_parser.RULE_noncondexpression = 16;
painless_parser.RULE_expression = 17;
painless_parser.RULE_unary = 18;
painless_parser.RULE_unarynotaddsub = 19;
painless_parser.RULE_castexpression = 20;
painless_parser.RULE_primordefcasttype = 21;
painless_parser.RULE_refcasttype = 22;
painless_parser.RULE_chain = 23;
painless_parser.RULE_primary = 24;
painless_parser.RULE_postfix = 25;
painless_parser.RULE_postdot = 26;
painless_parser.RULE_callinvoke = 27;
painless_parser.RULE_fieldaccess = 28;
painless_parser.RULE_braceaccess = 29;
painless_parser.RULE_arrayinitializer = 30;
painless_parser.RULE_listinitializer = 31;
painless_parser.RULE_mapinitializer = 32;
painless_parser.RULE_maptoken = 33;
painless_parser.RULE_arguments = 34;
painless_parser.RULE_argument = 35;
painless_parser.RULE_lambda = 36;
painless_parser.RULE_lamtype = 37;
painless_parser.RULE_funcref = 38;
// tslint:disable:no-trailing-whitespace
painless_parser.ruleNames = [
...
painless_parser._LITERAL_NAMES = [
...
painless_parser._SYMBOLIC_NAMES = [
...
painless_parser.VOCABULARY = new VocabularyImpl_1.VocabularyImpl(painless_parser._LITERAL_NAMES, painless_parser._SYMBOLIC_NAMES, []);
painless_parser._serializedATNSegments = 2;
painless_parser._serializedATNSegment0 = "\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x03W\u023E\x04\x02" +
    ...
    "\x02\u0225\u0226";
painless_parser._serializedATNSegment1 = "\x03\x02\x02\x02\u0226\u0229\x079\x02\x02\u0227\u022A\x05\x10\t\x02\u0228" +
    ...
    "\u01D4\u01D7\u01DD\u01E0\u01E8\u01EF\u01F7\u01FF\u020B\u020E\u0215\u021E" +
    "\u0221\u0224\u0229\u022C\u023B";
painless_parser._serializedATN = Utils.join([
...
class SourceContext extends ParserRuleContext_1.ParserRuleContext {
    EOF() { return this.getToken(painless_parser.EOF, 0); }
    function(i) {
        if (i === undefined) {
    ...
    // @Override
    get ruleIndex() { return painless_parser.RULE_source; }
    // @Override
    enterRule(listener) {
...
class FunctionContext extends ParserRuleContext_1.ParserRuleContext {
    ...
    ID() { return this.getToken(painless_parser.ID, 0); }
    parameters() {
    ...
    // @Override
    get ruleIndex() { return painless_parser.RULE_function; }
    // @Override
    enterRule(listener) {
...
class ParametersContext extends ParserRuleContext_1.ParserRuleContext {
    LP() { return this.getToken(painless_parser.LP, 0); }
    RP() { return this.getToken(painless_parser.RP, 0); }
    decltype(i) {
        if (i === undefined) {
    ...
    // @Override
    get ruleIndex() { return painless_parser.RULE_parameters; }
    // @Override
    enterRule(listener) {
...
class StatementContext extends ParserRuleContext_1.ParserRuleContext {
    ...
    SEMICOLON() { return this.tryGetToken(painless_parser.SEMICOLON, 0); }
    EOF() { return this.tryGetToken(painless_parser.EOF, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return painless_parser.RULE_statement; }
    // @Override
    enterRule(listener) {
...
class RstatementContext extends ParserRuleContext_1.ParserRuleContext {
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return painless_parser.RULE_rstatement; }
    copyFrom(ctx) {
        super.copyFrom(ctx);
    }
}
...
class IfContext extends RstatementContext {
    IF() { return this.getToken(painless_parser.IF, 0); }
    LP() { return this.getToken(painless_parser.LP, 0); }
    expression() {
    ...
    ELSE() { return this.tryGetToken(painless_parser.ELSE, 0); }
    constructor(ctx) {
...
class WhileContext extends RstatementContext {
    WHILE() { return this.getToken(painless_parser.WHILE, 0); }
    LP() { return this.getToken(painless_parser.LP, 0); }
    expression() {
        return this.getRuleContext(0, ExpressionContext);
    }
...
class ForContext extends RstatementContext {
    FOR() { return this.getToken(painless_parser.FOR, 0); }
    LP() { return this.getToken(painless_parser.LP, 0); }
    SEMICOLON(i) {
        if (i === undefined) {
...
class EachContext extends RstatementContext {
    ...
    ID() { return this.getToken(painless_parser.ID, 0); }
    COLON() { return this.getToken(painless_parser.COLON, 0); }
    expression() {
        return this.getRuleContext(0, ExpressionContext);
    }
    RP() { return this.getToken(painless_parser.RP, 0); }
...
class IneachContext extends RstatementContext {
    ...
    LP() { return this.getToken(painless_parser.LP, 0); }
    ID() { return this.getToken(painless_parser.ID, 0); }
    IN() { return this.getToken(painless_parser.IN, 0); }
    expression() {
        return this.getRuleContext(0, ExpressionContext);
    }
    RP() { return this.getToken(painless_parser.RP, 0); }
...
class TryContext extends RstatementContext {
    TRY() { return this.getToken(painless_parser.TRY, 0); }
    block() {
        return this.getRuleContext(0, BlockContext);
    }
    trap(i) {
...
class DstatementContext extends ParserRuleContext_1.ParserRuleContext {
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return painless_parser.RULE_dstatement; }
    copyFrom(ctx) {
        super.copyFrom(ctx);
    }
}
...
class DoContext extends DstatementContext {
    DO() { return this.getToken(painless_parser.DO, 0); }
    block() {
        return this.getRuleContext(0, BlockContext);
    }
    WHILE() { return this.getToken(painless_parser.WHILE, 0); }
...
class ContinueContext extends DstatementContext {
    CONTINUE() { return this.getToken(painless_parser.CONTINUE, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
class BreakContext extends DstatementContext {
    BREAK() { return this.getToken(painless_parser.BREAK, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
class ReturnContext extends DstatementContext {
    RETURN() { return this.getToken(painless_parser.RETURN, 0); }
    expression() {
        return this.tryGetRuleContext(0, ExpressionContext);
    }
    constructor(ctx) {
...
class ThrowContext extends DstatementContext {
    THROW() { return this.getToken(painless_parser.THROW, 0); }
    expression() {
        return this.getRuleContext(0, ExpressionContext);
    }
    constructor(ctx) {
...
class TrailerContext extends ParserRuleContext_1.ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return painless_parser.RULE_trailer; }
    // @Override
    enterRule(listener) {
...
class BlockContext extends ParserRuleContext_1.ParserRuleContext {
    LBRACK() { return this.getToken(painless_parser.LBRACK, 0); }
    RBRACK() { return this.getToken(painless_parser.RBRACK, 0); }
    statement(i) {
        if (i === undefined) {
            return this.getRuleContexts(StatementContext);
        }
    ...
    // @Override
    get ruleIndex() { return painless_parser.RULE_block; }
    // @Override
    enterRule(listener) {
...
class EmptyContext extends ParserRuleContext_1.ParserRuleContext {
    SEMICOLON() { return this.getToken(painless_parser.SEMICOLON, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return painless_parser.RULE_empty; }
    // @Override
    enterRule(listener) {
...
class InitializerContext extends ParserRuleContext_1.ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return painless_parser.RULE_initializer; }
    // @Override
    enterRule(listener) {
...
class AfterthoughtContext extends ParserRuleContext_1.ParserRuleContext {
    expression() {
        return this.getRuleContext(0, ExpressionContext);
    }
    constructor(parent, invokingState) {
    ...
    // @Override
    get ruleIndex() { return painless_parser.RULE_afterthought; }
    // @Override
    enterRule(listener) {
...
class DeclarationContext extends ParserRuleContext_1.ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return painless_parser.RULE_declaration; }
    // @Override
    enterRule(listener) {
...
class DecltypeContext extends ParserRuleContext_1.ParserRuleContext {
    type() {
    ...
    // @Override
    get ruleIndex() { return painless_parser.RULE_decltype; }
    // @Override
    enterRule(listener) {
...
class TypeContext extends ParserRuleContext_1.ParserRuleContext {
    DEF() { return this.tryGetToken(painless_parser.DEF, 0); }
    PRIMITIVE() { return this.tryGetToken(painless_parser.PRIMITIVE, 0); }
    ID() { return this.tryGetToken(painless_parser.ID, 0); }
    DOT(i) {
        if (i === undefined) {
    ...
    // @Override
    get ruleIndex() { return painless_parser.RULE_type; }
    // @Override
    enterRule(listener) {
...
class DeclvarContext extends ParserRuleContext_1.ParserRuleContext {
    ID() { return this.getToken(painless_parser.ID, 0); }
    ASSIGN() { return this.tryGetToken(painless_parser.ASSIGN, 0); }
    expression() {
        return this.tryGetRuleContext(0, ExpressionContext);
    }
    constructor(parent, invokingState) {
    ...
    // @Override
    get ruleIndex() { return painless_parser.RULE_declvar; }
    // @Override
    enterRule(listener) {
...
class TrapContext extends ParserRuleContext_1.ParserRuleContext {
    CATCH() { return this.getToken(painless_parser.CATCH, 0); }
    LP() { return this.getToken(painless_parser.LP, 0); }
    type() {
        return this.getRuleContext(0, TypeContext);
    }
    ...
    // @Override
    get ruleIndex() { return painless_parser.RULE_trap; }
    // @Override
    enterRule(listener) {
...
class NoncondexpressionContext extends ParserRuleContext_1.ParserRuleContext {
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return painless_parser.RULE_noncondexpression; }
    copyFrom(ctx) {
        super.copyFrom(ctx);
    }
}
...
class BinaryContext extends NoncondexpressionContext {
    ...
    MUL() { return this.tryGetToken(painless_parser.MUL, 0); }
    DIV() { return this.tryGetToken(painless_parser.DIV, 0); }
    REM() { return this.tryGetToken(painless_parser.REM, 0); }
    ADD() { return this.tryGetToken(painless_parser.ADD, 0); }
    SUB() { return this.tryGetToken(painless_parser.SUB, 0); }
    FIND() { return this.tryGetToken(painless_parser.FIND, 0); }
    MATCH() { return this.tryGetToken(painless_parser.MATCH, 0); }
    LSH() { return this.tryGetToken(painless_parser.LSH, 0); }
    RSH() { return this.tryGetToken(painless_parser.RSH, 0); }
    USH() { return this.tryGetToken(painless_parser.USH, 0); }
    BWAND() { return this.tryGetToken(painless_parser.BWAND, 0); }
    XOR() { return this.tryGetToken(painless_parser.XOR, 0); }
    BWOR() { return this.tryGetToken(painless_parser.BWOR, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
class CompContext extends NoncondexpressionContext {
    ...
    LT() { return this.tryGetToken(painless_parser.LT, 0); }
    LTE() { return this.tryGetToken(painless_parser.LTE, 0); }
    GT() { return this.tryGetToken(painless_parser.GT, 0); }
    GTE() { return this.tryGetToken(painless_parser.GTE, 0); }
    EQ() { return this.tryGetToken(painless_parser.EQ, 0); }
    EQR() { return this.tryGetToken(painless_parser.EQR, 0); }
    NE() { return this.tryGetToken(painless_parser.NE, 0); }
    NER() { return this.tryGetToken(painless_parser.NER, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
class InstanceofContext extends NoncondexpressionContext {
    ...
    INSTANCEOF() { return this.getToken(painless_parser.INSTANCEOF, 0); }
    decltype() {
        return this.getRuleContext(0, DecltypeContext);
    }
    constructor(ctx) {
...
class BoolContext extends NoncondexpressionContext {
    ...
    BOOLAND() { return this.tryGetToken(painless_parser.BOOLAND, 0); }
    BOOLOR() { return this.tryGetToken(painless_parser.BOOLOR, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
class ElvisContext extends NoncondexpressionContext {
    ...
    ELVIS() { return this.getToken(painless_parser.ELVIS, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
class ExpressionContext extends ParserRuleContext_1.ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return painless_parser.RULE_expression; }
    copyFrom(ctx) {
        super.copyFrom(ctx);
    }
}
...
class ConditionalContext extends ExpressionContext {
    ...
    COND() { return this.getToken(painless_parser.COND, 0); }
    expression(i) {
        if (i === undefined) {
...
class AssignmentContext extends ExpressionContext {
    ...
    ASSIGN() { return this.tryGetToken(painless_parser.ASSIGN, 0); }
    AADD() { return this.tryGetToken(painless_parser.AADD, 0); }
    ASUB() { return this.tryGetToken(painless_parser.ASUB, 0); }
    AMUL() { return this.tryGetToken(painless_parser.AMUL, 0); }
    ADIV() { return this.tryGetToken(painless_parser.ADIV, 0); }
    AREM() { return this.tryGetToken(painless_parser.AREM, 0); }
    AAND() { return this.tryGetToken(painless_parser.AAND, 0); }
    AXOR() { return this.tryGetToken(painless_parser.AXOR, 0); }
    AOR() { return this.tryGetToken(painless_parser.AOR, 0); }
    ALSH() { return this.tryGetToken(painless_parser.ALSH, 0); }
    ARSH() { return this.tryGetToken(painless_parser.ARSH, 0); }
    AUSH() { return this.tryGetToken(painless_parser.AUSH, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
class UnaryContext extends ParserRuleContext_1.ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return painless_parser.RULE_unary; }
    copyFrom(ctx) {
        super.copyFrom(ctx);
    }
}
...
class PreContext extends UnaryContext {
    ...
    INCR() { return this.tryGetToken(painless_parser.INCR, 0); }
    DECR() { return this.tryGetToken(painless_parser.DECR, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
class UnarynotaddsubContext extends ParserRuleContext_1.ParserRuleContext {
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return painless_parser.RULE_unarynotaddsub; }
    copyFrom(ctx) {
        super.copyFrom(ctx);
    }
}
...
class NotContext extends UnarynotaddsubContext {
    ...
    BOOLNOT() { return this.tryGetToken(painless_parser.BOOLNOT, 0); }
    BWNOT() { return this.tryGetToken(painless_parser.BWNOT, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
class CastexpressionContext extends ParserRuleContext_1.ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return painless_parser.RULE_castexpression; }
    copyFrom(ctx) {
        super.copyFrom(ctx);
    }
}
...
class PrimordefcasttypeContext extends ParserRuleContext_1.ParserRuleContext {
    DEF() { return this.tryGetToken(painless_parser.DEF, 0); }
    PRIMITIVE() { return this.tryGetToken(painless_parser.PRIMITIVE, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    ...
    // @Override
    get ruleIndex() { return painless_parser.RULE_primordefcasttype; }
    // @Override
    enterRule(listener) {
...
class RefcasttypeContext extends ParserRuleContext_1.ParserRuleContext {
    DEF() { return this.tryGetToken(painless_parser.DEF, 0); }
    LBRACE(i) {
        if (i === undefined) {
            return this.getTokens(painless_parser.LBRACE);
    ...
    // @Override
    get ruleIndex() { return painless_parser.RULE_refcasttype; }
    // @Override
    enterRule(listener) {
...
class ChainContext extends ParserRuleContext_1.ParserRuleContext {
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return painless_parser.RULE_chain; }
    copyFrom(ctx) {
        super.copyFrom(ctx);
    }
}
...
class PrimaryContext extends ParserRuleContext_1.ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return painless_parser.RULE_primary; }
    copyFrom(ctx) {
        super.copyFrom(ctx);
    }
}
...
class NumericContext extends PrimaryContext {
    OCTAL() { return this.tryGetToken(painless_parser.OCTAL, 0); }
    HEX() { return this.tryGetToken(painless_parser.HEX, 0); }
    INTEGER() { return this.tryGetToken(painless_parser.INTEGER, 0); }
    DECIMAL() { return this.tryGetToken(painless_parser.DECIMAL, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
class TrueContext extends PrimaryContext {
    TRUE() { return this.getToken(painless_parser.TRUE, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
class FalseContext extends PrimaryContext {
    FALSE() { return this.getToken(painless_parser.FALSE, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
class NullContext extends PrimaryContext {
    NULL() { return this.getToken(painless_parser.NULL, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
class StringContext extends PrimaryContext {
    STRING() { return this.getToken(painless_parser.STRING, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
class RegexContext extends PrimaryContext {
    REGEX() { return this.getToken(painless_parser.REGEX, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
    }
...
class NewobjectContext extends PrimaryContext {
    NEW() { return this.getToken(painless_parser.NEW, 0); }
    type() {
        return this.getRuleContext(0, TypeContext);
    }
    arguments() {
...
class PostfixContext extends ParserRuleContext_1.ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return painless_parser.RULE_postfix; }
    // @Override
    enterRule(listener) {
...
class PostdotContext extends ParserRuleContext_1.ParserRuleContext {
    callinvoke() {
        return this.tryGetRuleContext(0, CallinvokeContext);
    }
    fieldaccess() {
    ...
    // @Override
    get ruleIndex() { return painless_parser.RULE_postdot; }
    // @Override
    enterRule(listener) {
...
class CallinvokeContext extends ParserRuleContext_1.ParserRuleContext {
    DOTID() { return this.getToken(painless_parser.DOTID, 0); }
    arguments() {
        return this.getRuleContext(0, ArgumentsContext);
    }
    DOT() { return this.tryGetToken(painless_parser.DOT, 0); }
    NSDOT() { return this.tryGetToken(painless_parser.NSDOT, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return painless_parser.RULE_callinvoke; }
    // @Override
    enterRule(listener) {
...
class FieldaccessContext extends ParserRuleContext_1.ParserRuleContext {
    DOT() { return this.tryGetToken(painless_parser.DOT, 0); }
    NSDOT() { return this.tryGetToken(painless_parser.NSDOT, 0); }
    DOTID() { return this.tryGetToken(painless_parser.DOTID, 0); }
    DOTINTEGER() { return this.tryGetToken(painless_parser.DOTINTEGER, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return painless_parser.RULE_fieldaccess; }
    // @Override
    enterRule(listener) {
...
class BraceaccessContext extends ParserRuleContext_1.ParserRuleContext {
    LBRACE() { return this.getToken(painless_parser.LBRACE, 0); }
    expression() {
        return this.getRuleContext(0, ExpressionContext);
    }
    RBRACE() { return this.getToken(painless_parser.RBRACE, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return painless_parser.RULE_braceaccess; }
    // @Override
    enterRule(listener) {
...
class ArrayinitializerContext extends ParserRuleContext_1.ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return painless_parser.RULE_arrayinitializer; }
    copyFrom(ctx) {
        super.copyFrom(ctx);
    }
}
...
class ListinitializerContext extends ParserRuleContext_1.ParserRuleContext {
    LBRACE() { return this.getToken(painless_parser.LBRACE, 0); }
    expression(i) {
        if (i === undefined) {
            return this.getRuleContexts(ExpressionContext);
    ...
    // @Override
    get ruleIndex() { return painless_parser.RULE_listinitializer; }
    // @Override
    enterRule(listener) {
...
class MapinitializerContext extends ParserRuleContext_1.ParserRuleContext {
    LBRACE() { return this.getToken(painless_parser.LBRACE, 0); }
    maptoken(i) {
        if (i === undefined) {
    ...
    COLON() { return this.tryGetToken(painless_parser.COLON, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return painless_parser.RULE_mapinitializer; }
    // @Override
    enterRule(listener) {
...
class MaptokenContext extends ParserRuleContext_1.ParserRuleContext {
    expression(i) {
        if (i === undefined) {
            return this.getRuleContexts(ExpressionContext);
        }
    ...
    // @Override
    get ruleIndex() { return painless_parser.RULE_maptoken; }
    // @Override
    enterRule(listener) {
...
class ArgumentsContext extends ParserRuleContext_1.ParserRuleContext {
    LP() { return this.tryGetToken(painless_parser.LP, 0); }
    RP() { return this.tryGetToken(painless_parser.RP, 0); }
    argument(i) {
        if (i === undefined) {
    ...
    // @Override
    get ruleIndex() { return painless_parser.RULE_arguments; }
    // @Override
    enterRule(listener) {
...
class ArgumentContext extends ParserRuleContext_1.ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return painless_parser.RULE_argument; }
    // @Override
    enterRule(listener) {
...
class LambdaContext extends ParserRuleContext_1.ParserRuleContext {
    ARROW() { return this.getToken(painless_parser.ARROW, 0); }
    lamtype(i) {
        if (i === undefined) {
    ...
    // @Override
    get ruleIndex() { return painless_parser.RULE_lambda; }
    // @Override
    enterRule(listener) {
...
class LamtypeContext extends ParserRuleContext_1.ParserRuleContext {
    ID() { return this.getToken(painless_parser.ID, 0); }
    decltype() {
    ...
    // @Override
    get ruleIndex() { return painless_parser.RULE_lamtype; }
    // @Override
    enterRule(listener) {
...
class FuncrefContext extends ParserRuleContext_1.ParserRuleContext {
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return painless_parser.RULE_funcref; }
    copyFrom(ctx) {
        super.copyFrom(ctx);
    }
}
...
class ClassfuncrefContext extends FuncrefContext {
    ...
    REF() { return this.getToken(painless_parser.REF, 0); }
    ID() { return this.getToken(painless_parser.ID, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
        this.copyFrom(ctx);
...
class LocalfuncrefContext extends FuncrefContext {
    THIS() { return this.getToken(painless_parser.THIS, 0); }
    REF() { return this.getToken(painless_parser.REF, 0); }
    ID() { return this.getToken(painless_parser.ID, 0); }
    constructor(ctx) {
        super(ctx.parent, ctx.invokingState);
...
//# sourceMappingURL=painless_parser.js.map