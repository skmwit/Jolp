...
exports.showStaticSuggestions = exports.isDeclaringField = exports.isConstructorInstance = exports.isDefiningString = exports.isDefiningBoolean = exports.hasDeclaredType = exports.isAccessingProperty = void 0;
/**
...
const showStaticSuggestions = (activeTyping, activeLineWords, primitives) => {
    const activeTypingParts = activeTyping.split('.');
    return (exports.hasDeclaredType(activeLineWords, primitives) === false &&
        exports.isDefiningBoolean(activeLineWords) === false &&
        exports.isDefiningString(activeTyping) === false &&
        activeTypingParts.length === 1);
};
exports.showStaticSuggestions = showStaticSuggestions;
//# sourceMappingURL=autocomplete_utils.js.map