...
import { isPseudoLocale, translateUsingPseudoLocale } from './pseudo_locale'; // Add all locale data to `IntlMessageFormat`.
...
export function addTranslation(newTranslation, locale = newTranslation.locale) {
  ...
  translationsForLocale[normalizedLocale] = {
    ...
    messages: { ...existingTranslation.messages,
