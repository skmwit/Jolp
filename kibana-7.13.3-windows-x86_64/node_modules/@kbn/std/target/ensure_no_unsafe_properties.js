...
exports.ensureNoUnsafeProperties = void 0;
...
function ensureNoUnsafeProperties(obj) {
    if (!isObject(obj)) {
        return;
    }
    const stack = [
...
exports.ensureNoUnsafeProperties = ensureNoUnsafeProperties;
//# sourceMappingURL=ensure_no_unsafe_properties.js.map