 ...
 * @public
 */
const appendersSchema = _configSchema.schema.oneOf([_console_appender.ConsoleAppender.configSchema, _file_appender.FileAppender.configSchema, _legacy_appender.LegacyAppender.configSchema, _rewrite_appender.RewriteAppender.configSchema, _rolling_file_appender.RollingFileAppender.configSchema]);
/** @public */
