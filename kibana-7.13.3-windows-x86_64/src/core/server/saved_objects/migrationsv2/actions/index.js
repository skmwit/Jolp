 ...
 * settings.
 */
const fetchIndices = (client, indicesToFetch) => // @ts-expect-error @elastic/elasticsearch IndexState.alias and IndexState.mappings should be required
() => {
...
const catchWaitForTaskCompletionTimeout = e => {
  var _e$body2, _e$body2$error, _e$body3, _e$body3$error;

  if (((_e$body2 = e.body) === null || _e$body2 === void 0 ? void 0 : (_e$body2$error = _e$body2.error) === null || _e$body2$error === void 0 ? void 0 : _e$body2$error.type) === 'timeout_exception' || ((_e$body3 = e.body) === null || _e$body3 === void 0 ? void 0 : (_e$body3$error = _e$body3.error) === null || _e$body3$error === void 0 ? void 0 : _e$body3$error.type) === 'receive_timeout_transport_exception') {
    return Either.left({
...
const createIndex = (client, indexName, mappings, aliases) => {
  const createIndexTask = () => {
    ...
    return client.indices.create({
      ...
      var _error$body3, _error$body3$error;

      if ((error === null || error === void 0 ? void 0 : (_error$body3 = error.body) === null || _error$body3 === void 0 ? void 0 : (_error$body3$error = _error$body3.error) === null || _error$body3$error === void 0 ? void 0 : _error$body3$error.type) === 'resource_already_exists_exception') {
        /**
...
const bulkOverwriteTransformedDocuments = (client, index, transformedDocs) => () => {
  return client.bulk({
    ...
    const errors = ((_res$body$items = res.body.items) !== null && _res$body$items !== void 0 ? _res$body$items : []).filter(item => {
      var _item$index, _item$index$error;

      return ((_item$index = item.index) === null || _item$index === void 0 ? void 0 : (_item$index$error = _item$index.error) === null || _item$index$error === void 0 ? void 0 : _item$index$error.type) !== 'version_conflict_engine_exception';
    });
