...
class CspConfig {
  ...
  constructor(rawCspConfig = {}) {
    ...
    _defineProperty(this, "disableEmbedding", void 0);
    ...
    if (!((_rawCspConfig$rules = rawCspConfig.rules) !== null && _rawCspConfig$rules !== void 0 && _rawCspConfig$rules.length) && source.disableEmbedding) {
      this.rules.push(_config.FRAME_ANCESTORS_RULE);
    }
