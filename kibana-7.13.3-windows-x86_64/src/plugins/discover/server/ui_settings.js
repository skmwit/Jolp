...
const uiSettings = {
  ...
  [_common.DOC_TABLE_LEGACY]: {
    ...
    description: _i18n.i18n.translate('discover.advancedSettings.docTableVersionDescription', {
      defaultMessage: 'Discover uses a new table layout that includes better data sorting, drag-and-drop columns, and a full screen view. ' + 'Turn on this option to use the classic table. Turn off to use the new table. '
    }),
    category: ['discover'],
    schema: _configSchema.schema.boolean(),
    metric: {
