...
exports.createPhpAgentInstructions = exports.createDotNetAgentInstructions = exports.createJavaAgentInstructions = exports.createGoAgentInstructions = exports.createJsAgentInstructions = exports.createRackAgentInstructions = exports.createRailsAgentInstructions = exports.createFlaskAgentInstructions = exports.createDjangoAgentInstructions = exports.createNodeAgentInstructions = void 0;
...
const createNodeAgentInstructions = (apmServerUrl = '', secretToken = '') => [{
  title: _i18n.i18n.translate('apmOss.tutorial.nodeClient.install.title', {
    defaultMessage: 'Install the APM agent'
  }),
  textPre: _i18n.i18n.translate('apmOss.tutorial.nodeClient.install.textPre', {
  ...
  title: _i18n.i18n.translate('apmOss.tutorial.nodeClient.configure.title', {
    defaultMessage: 'Configure the agent'
  }),
  textPre: _i18n.i18n.translate('apmOss.tutorial.nodeClient.configure.textPre', {
...
This agent supports a variety of frameworks but can also be used with your custom stack.'
  ...
  commands: `// ${_i18n.i18n.translate('apmOss.tutorial.nodeClient.configure.commands.addThisToTheFileTopComment', {
...
var apm = require('elastic-apm-node').start({curlyOpen}
  ...
  // ${_i18n.i18n.translate('apmOss.tutorial.nodeClient.configure.commands.setRequiredServiceNameComment', {
    defaultMessage: 'Override the service name from package.json'
  })}
  // ${_i18n.i18n.translate('apmOss.tutorial.nodeClient.configure.commands.allowedCharactersComment', {
    defaultMessage: 'Allowed characters: a-z, A-Z, 0-9, -, _, and space'
  })}
  serviceName: '',

  // ${_i18n.i18n.translate('apmOss.tutorial.nodeClient.configure.commands.useIfApmRequiresTokenComment', {
    defaultMessage: 'Use if APM Server requires a secret token'
  })}
  secretToken: '${secretToken}',

  // ${_i18n.i18n.translate('apmOss.tutorial.nodeClient.configure.commands.setCustomApmServerUrlComment', {
  ...
  // ${_i18n.i18n.translate('apmOss.tutorial.nodeClient.configure.commands.setCustomServiceEnvironmentComment', {
    defaultMessage: 'Set the service environment'
  })}
  environment: 'production'
{curlyClose})`.split('\n'),
  textPost: _i18n.i18n.translate('apmOss.tutorial.nodeClient.configure.textPost', {
...
const createDjangoAgentInstructions = (apmServerUrl = '', secretToken = '') => [{
  title: _i18n.i18n.translate('apmOss.tutorial.djangoClient.install.title', {
    defaultMessage: 'Install the APM agent'
  }),
  textPre: _i18n.i18n.translate('apmOss.tutorial.djangoClient.install.textPre', {
    defaultMessage: 'Install the APM agent for Python as a dependency.'
  }),
  commands: ['$ pip install elastic-apm']
}, {
  title: _i18n.i18n.translate('apmOss.tutorial.djangoClient.configure.title', {
    defaultMessage: 'Configure the agent'
  }),
  textPre: _i18n.i18n.translate('apmOss.tutorial.djangoClient.configure.textPre', {
    defaultMessage: 'Agents are libraries that run inside of your application process. \
APM services are created programmatically based on the `SERVICE_NAME`.'
  }),
  commands: `# ${_i18n.i18n.translate('apmOss.tutorial.djangoClient.configure.commands.addAgentComment', {
...
ELASTIC_APM = {curlyOpen}
  # ${_i18n.i18n.translate('apmOss.tutorial.djangoClient.configure.commands.setRequiredServiceNameComment', {
    defaultMessage: 'Set the required service name. Allowed characters:'
  })}
  # ${_i18n.i18n.translate('apmOss.tutorial.djangoClient.configure.commands.allowedCharactersComment', {
    defaultMessage: 'a-z, A-Z, 0-9, -, _, and space'
  })}
  'SERVICE_NAME': '',

  # ${_i18n.i18n.translate('apmOss.tutorial.djangoClient.configure.commands.useIfApmServerRequiresTokenComment', {
    defaultMessage: 'Use if APM Server requires a secret token'
  })}
  'SECRET_TOKEN': '${secretToken}',

  # ${_i18n.i18n.translate('apmOss.tutorial.djangoClient.configure.commands.setCustomApmServerUrlComment', {
    defaultMessage: 'Set the custom APM Server URL (default: {defaultApmServerUrl})',
    values: {
      defaultApmServerUrl: 'http://localhost:8200'
    }
  ...
  # ${_i18n.i18n.translate('apmOss.tutorial.djangoClient.configure.commands.setServiceEnvironmentComment', {
    defaultMessage: 'Set the service environment'
  })}
  'ENVIRONMENT': 'production',
{curlyClose}

# ${_i18n.i18n.translate('apmOss.tutorial.djangoClient.configure.commands.addTracingMiddlewareComment', {
...
MIDDLEWARE = (
  ...
  textPost: _i18n.i18n.translate('apmOss.tutorial.djangoClient.configure.textPost', {
...
const createFlaskAgentInstructions = (apmServerUrl = '', secretToken = '') => [{
  title: _i18n.i18n.translate('apmOss.tutorial.flaskClient.install.title', {
    defaultMessage: 'Install the APM agent'
  }),
  textPre: _i18n.i18n.translate('apmOss.tutorial.flaskClient.install.textPre', {
    defaultMessage: 'Install the APM agent for Python as a dependency.'
  }),
  commands: ['$ pip install elastic-apm[flask]']
}, {
  title: _i18n.i18n.translate('apmOss.tutorial.flaskClient.configure.title', {
    defaultMessage: 'Configure the agent'
  }),
  textPre: _i18n.i18n.translate('apmOss.tutorial.flaskClient.configure.textPre', {
    defaultMessage: 'Agents are libraries that run inside of your application process. \
APM services are created programmatically based on the `SERVICE_NAME`.'
  }),
  commands: `# ${_i18n.i18n.translate('apmOss.tutorial.flaskClient.configure.commands.initializeUsingEnvironmentVariablesComment', {
...
# ${_i18n.i18n.translate('apmOss.tutorial.flaskClient.configure.commands.configureElasticApmComment', {
    defaultMessage: "or configure to use ELASTIC_APM in your application's settings"
  })}
from elasticapm.contrib.flask import ElasticAPM
app.config['ELASTIC_APM'] = {curlyOpen}
  # ${_i18n.i18n.translate('apmOss.tutorial.flaskClient.configure.commands.setRequiredServiceNameComment', {
    defaultMessage: 'Set the required service name. Allowed characters:'
  })}
  # ${_i18n.i18n.translate('apmOss.tutorial.flaskClient.configure.commands.allowedCharactersComment', {
    defaultMessage: 'a-z, A-Z, 0-9, -, _, and space'
  })}
  'SERVICE_NAME': '',

  # ${_i18n.i18n.translate('apmOss.tutorial.flaskClient.configure.commands.useIfApmServerRequiresTokenComment', {
    defaultMessage: 'Use if APM Server requires a secret token'
  })}
  'SECRET_TOKEN': '${secretToken}',

  # ${_i18n.i18n.translate('apmOss.tutorial.flaskClient.configure.commands.setCustomApmServerUrlComment', {
    defaultMessage: 'Set the custom APM Server URL (default: {defaultApmServerUrl})',
    values: {
      defaultApmServerUrl: 'http://localhost:8200'
    }
  ...
  # ${_i18n.i18n.translate('apmOss.tutorial.flaskClient.configure.commands.setServiceEnvironmentComment', {
    defaultMessage: 'Set the service environment'
  })}
  'ENVIRONMENT': 'production',
{curlyClose}
...
apm = ElasticAPM(app)`.split('\n'),
  textPost: _i18n.i18n.translate('apmOss.tutorial.flaskClient.configure.textPost', {
    defaultMessage: 'See the [documentation]({documentationLink}) for advanced usage.',
    values: {
...
const createRailsAgentInstructions = (apmServerUrl = '', secretToken = '') => [{
  title: _i18n.i18n.translate('apmOss.tutorial.railsClient.install.title', {
    defaultMessage: 'Install the APM agent'
  }),
  textPre: _i18n.i18n.translate('apmOss.tutorial.railsClient.install.textPre', {
    defaultMessage: 'Add the agent to your Gemfile.'
  }),
  commands: [`gem 'elastic-apm'`]
}, {
  title: _i18n.i18n.translate('apmOss.tutorial.railsClient.configure.title', {
    defaultMessage: 'Configure the agent'
  }),
  textPre: _i18n.i18n.translate('apmOss.tutorial.railsClient.configure.textPre', {
...
environment: 'production'`.split('\n'),
  textPost: _i18n.i18n.translate('apmOss.tutorial.railsClient.configure.textPost', {
...
const createRackAgentInstructions = (apmServerUrl = '', secretToken = '') => [{
  title: _i18n.i18n.translate('apmOss.tutorial.rackClient.install.title', {
    defaultMessage: 'Install the APM agent'
  }),
  textPre: _i18n.i18n.translate('apmOss.tutorial.rackClient.install.textPre', {
    defaultMessage: 'Add the agent to your Gemfile.'
  }),
  commands: [`gem 'elastic-apm'`]
}, {
  title: _i18n.i18n.translate('apmOss.tutorial.rackClient.configure.title', {
    defaultMessage: 'Configure the agent'
  }),
  textPre: _i18n.i18n.translate('apmOss.tutorial.rackClient.configure.textPre', {
  ...
  ElasticAPM.start(
    app: MySinatraApp, # ${_i18n.i18n.translate('apmOss.tutorial.rackClient.configure.commands.requiredComment', {
    defaultMessage: 'required'
  })}
    config_file: '' # ${_i18n.i18n.translate('apmOss.tutorial.rackClient.configure.commands.optionalComment', {
  ...
  title: _i18n.i18n.translate('apmOss.tutorial.rackClient.createConfig.title', {
    defaultMessage: 'Create config file'
  }),
  textPre: _i18n.i18n.translate('apmOss.tutorial.rackClient.createConfig.textPre', {
...
# ${_i18n.i18n.translate('apmOss.tutorial.rackClient.createConfig.commands.setServiceNameComment', {
    defaultMessage: 'Set the service name - allowed characters: a-z, A-Z, 0-9, -, _ and space'
  })}
# ${_i18n.i18n.translate('apmOss.tutorial.rackClient.createConfig.commands.defaultsToTheNameOfRackAppClassComment', {
    defaultMessage: "Defaults to the name of your Rack app's class."
  })}
service_name: 'my-service'

# ${_i18n.i18n.translate('apmOss.tutorial.rackClient.createConfig.commands.useIfApmServerRequiresTokenComment', {
    defaultMessage: 'Use if APM Server requires a token'
  })}
secret_token: '${secretToken}'

# ${_i18n.i18n.translate('apmOss.tutorial.rackClient.createConfig.commands.setCustomApmServerComment', {
...
# ${_i18n.i18n.translate('apmOss.tutorial.rackClient.createConfig.commands.setServiceEnvironment', {
    defaultMessage: 'Set the service environment'
  })}
environment: 'production'`.split('\n'),
  textPost: _i18n.i18n.translate('apmOss.tutorial.rackClient.createConfig.textPost', {
    defaultMessage: 'See the [documentation]({documentationLink}) for configuration options and advanced usage.\n\n',
    values: {
      documentationLink: '{config.docs.base_url}guide/en/apm/agent/ruby/current/index.html'
    }
...
const createJsAgentInstructions = (apmServerUrl = '') => [{
  title: _i18n.i18n.translate('apmOss.tutorial.jsClient.enableRealUserMonitoring.title', {
    defaultMessage: 'Enable Real User Monitoring support in APM Server'
  }),
  textPre: _i18n.i18n.translate('apmOss.tutorial.jsClient.enableRealUserMonitoring.textPre', {
...
for details on how to enable RUM support.',
    values: {
      documentationLink: '{config.docs.base_url}guide/en/apm/server/{config.docs.version}/configuration-rum.html'
    }
  })
}, {
  title: _i18n.i18n.translate('apmOss.tutorial.jsClient.installDependency.title', {
    defaultMessage: 'Set up the Agent as a dependency'
  }),
  textPre: _i18n.i18n.translate('apmOss.tutorial.jsClient.installDependency.textPre', {
...
var apm = initApm({curlyOpen}
  ...
  // ${_i18n.i18n.translate('apmOss.tutorial.jsClient.installDependency.commands.setRequiredServiceNameComment', {
    defaultMessage: 'Set required service name (allowed characters: a-z, A-Z, 0-9, -, _, and space)'
  })}
  serviceName: '',

  // ${_i18n.i18n.translate('apmOss.tutorial.jsClient.installDependency.commands.setCustomApmServerUrlComment', {
  ...
  // ${_i18n.i18n.translate('apmOss.tutorial.jsClient.installDependency.commands.setServiceVersionComment', {
    defaultMessage: 'Set the service version (required for source map feature)'
  })}
  serviceVersion: '',

  // ${_i18n.i18n.translate('apmOss.tutorial.jsClient.installDependency.commands.setServiceEnvironmentComment', {
    defaultMessage: 'Set the service environment'
  })}
  environment: 'production'
{curlyClose})`.split('\n'),
  textPost: _i18n.i18n.translate('apmOss.tutorial.jsClient.installDependency.textPost', {
...
See the [integration documentation]({docLink}) for more information.',
  ...
  title: _i18n.i18n.translate('apmOss.tutorial.jsClient.scriptTags.title', {
    defaultMessage: 'Set up the Agent with Script Tags'
  }),
  textPre: _i18n.i18n.translate('apmOss.tutorial.jsClient.scriptTags.textPre', {
...
const createGoAgentInstructions = (apmServerUrl = '', secretToken = '') => [{
  title: _i18n.i18n.translate('apmOss.tutorial.goClient.install.title', {
    defaultMessage: 'Install the APM agent'
  }),
  textPre: _i18n.i18n.translate('apmOss.tutorial.goClient.install.textPre', {
    defaultMessage: 'Install the APM agent packages for Go.'
  }),
  commands: ['go get go.elastic.co/apm']
}, {
  title: _i18n.i18n.translate('apmOss.tutorial.goClient.configure.title', {
    defaultMessage: 'Configure the agent'
  }),
  textPre: _i18n.i18n.translate('apmOss.tutorial.goClient.configure.textPre', {
    defaultMessage: 'Agents are libraries that run inside of your application process. \
...
file name, or the `ELASTIC_APM_SERVICE_NAME` environment variable.'
  ...
  commands: `# ${_i18n.i18n.translate('apmOss.tutorial.goClient.configure.commands.initializeUsingEnvironmentVariablesComment', {
    defaultMessage: 'Initialize using environment variables:'
  })}

# ${_i18n.i18n.translate('apmOss.tutorial.goClient.configure.commands.setServiceNameComment', {
    defaultMessage: 'Set the service name. Allowed characters: # a-z, A-Z, 0-9, -, _, and space.'
  })}
# ${_i18n.i18n.translate('apmOss.tutorial.goClient.configure.commands.usedExecutableNameComment', {
    defaultMessage: 'If ELASTIC_APM_SERVICE_NAME is not specified, the executable name will be used.'
  })}
export ELASTIC_APM_SERVICE_NAME=

# ${_i18n.i18n.translate('apmOss.tutorial.goClient.configure.commands.setCustomApmServerUrlComment', {
    defaultMessage: 'Set custom APM Server URL (default: {defaultApmServerUrl})',
    values: {
      defaultApmServerUrl: 'http://localhost:8200'
    }
...
# ${_i18n.i18n.translate('apmOss.tutorial.goClient.configure.commands.useIfApmRequiresTokenComment', {
    defaultMessage: 'Use if APM Server requires a secret token'
  })}
export ELASTIC_APM_SECRET_TOKEN=${secretToken}

# ${_i18n.i18n.translate('apmOss.tutorial.goClient.configure.commands.setServiceEnvironment', {
    defaultMessage: 'Set the service environment'
  })}
export ELASTIC_APM_ENVIRONMENT=
`.split('\n'),
  textPost: _i18n.i18n.translate('apmOss.tutorial.goClient.configure.textPost', {
  ...
  title: _i18n.i18n.translate('apmOss.tutorial.goClient.instrument.title', {
    defaultMessage: 'Instrument your application'
  }),
  textPre: _i18n.i18n.translate('apmOss.tutorial.goClient.instrument.textPre', {
...
{curlyClose}
`.split('\n'),
  textPost: _i18n.i18n.translate('apmOss.tutorial.goClient.instrument.textPost', {
...
const createJavaAgentInstructions = (apmServerUrl = '', secretToken = '') => [{
  title: _i18n.i18n.translate('apmOss.tutorial.javaClient.download.title', {
    defaultMessage: 'Download the APM agent'
  }),
  textPre: _i18n.i18n.translate('apmOss.tutorial.javaClient.download.textPre', {
...
Do **not** add the agent as a dependency to your application.',
  ...
  title: _i18n.i18n.translate('apmOss.tutorial.javaClient.startApplication.title', {
    defaultMessage: 'Start your application with the javaagent flag'
  }),
  textPre: _i18n.i18n.translate('apmOss.tutorial.javaClient.startApplication.textPre', {
...
* Set the base package of your application',
  ...
  textPost: _i18n.i18n.translate('apmOss.tutorial.javaClient.startApplication.textPost', {
...
const createDotNetAgentInstructions = (apmServerUrl = '', secretToken = '') => [{
  title: _i18n.i18n.translate('apmOss.tutorial.dotNetClient.download.title', {
    defaultMessage: 'Download the APM agent'
  }),
  textPre: _i18n.i18n.translate('apmOss.tutorial.dotNetClient.download.textPre', {
  ...
  title: _i18n.i18n.translate('apmOss.tutorial.dotNetClient.configureApplication.title', {
    defaultMessage: 'Add the agent to the application'
  }),
  textPre: _i18n.i18n.translate('apmOss.tutorial.dotNetClient.configureApplication.textPre', {
...
{curlyOpen}
  ...
  //…rest of the class
{curlyClose}`.split('\n'),
  textPost: _i18n.i18n.translate('apmOss.tutorial.dotNetClient.configureApplication.textPost', {
  ...
  title: _i18n.i18n.translate('apmOss.tutorial.dotNetClient.configureAgent.title', {
  ...
  {curlyClose}
{curlyClose}`.split('\n'),
  textPost: _i18n.i18n.translate('apmOss.tutorial.dotNetClient.configureAgent.textPost', {
...
const createPhpAgentInstructions = (apmServerUrl = '', secretToken = '') => [{
  title: _i18n.i18n.translate('apmOss.tutorial.phpClient.download.title', {
    defaultMessage: 'Download the APM agent'
  }),
  textPre: _i18n.i18n.translate('apmOss.tutorial.phpClient.download.textPre', {
  ...
  title: _i18n.i18n.translate('apmOss.tutorial.phpClient.installPackage.title', {
    defaultMessage: 'Install the downloaded package'
  }),
  textPre: _i18n.i18n.translate('apmOss.tutorial.phpClient.installPackage.textPre', {
    defaultMessage: 'For example on Alpine Linux using APK package:'
  }),
  commands: ['apk add --allow-untrusted <package-file>.apk'],
  textPost: _i18n.i18n.translate('apmOss.tutorial.phpClient.installPackage.textPost', {
  ...
  title: _i18n.i18n.translate('apmOss.tutorial.phpClient.configureAgent.title', {
    defaultMessage: 'Configure the agent'
  }),
  textPre: _i18n.i18n.translate('apmOss.tutorial.phpClient.configureAgent.textPre', {
...
`.split('\n'),
  textPost: _i18n.i18n.translate('apmOss.tutorial.phpClient.configure.textPost', {
    defaultMessage: 'See the [documentation]({documentationLink}) for configuration options and advanced usage.\n\n',
    values: {
