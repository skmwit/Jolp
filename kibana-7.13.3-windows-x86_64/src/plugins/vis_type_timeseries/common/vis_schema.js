...
exports.visPayloadSchema = exports.panel = exports.seriesItems = exports.metricsItems = exports.annotationsItems = exports.fieldObject = exports.indexPattern = void 0;
...
const stringOptional = _configSchema.schema.maybe(_configSchema.schema.string());
...
const queryObject = _configSchema.schema.object({
  ...
  query: _configSchema.schema.oneOf([_configSchema.schema.string(), _configSchema.schema.any()])
});
...
const indexPattern = _configSchema.schema.oneOf([_configSchema.schema.maybe(_configSchema.schema.string()), _configSchema.schema.object({
...
const annotationsItems = _configSchema.schema.object({
  ...
  fields: _configSchema.schema.string(),
...
exports.annotationsItems = annotationsItems;
...
const seriesItems = _configSchema.schema.object({
  ...
  palette: _configSchema.schema.object({
    type: stringRequired,
    name: stringRequired
  }),
...
const panel = _configSchema.schema.object({
  use_kibana_indexes: _configSchema.schema.maybe(_configSchema.schema.boolean()),
  ...
  hide_last_value_indicator: _configSchema.schema.boolean(),
  id: stringRequired,
