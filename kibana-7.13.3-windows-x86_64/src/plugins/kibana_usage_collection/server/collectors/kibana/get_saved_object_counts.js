...
async function getSavedObjectsCounts(esClient, kibanaIndex) {
  ...
  const buckets = // @ts-expect-error @elastic/elasticsearch Aggregate does not include `buckets`
  ((_body$aggregations = body.aggregations) === null || _body$aggregations === void 0 ? void 0 : (_body$aggregations$ty = _body$aggregations.types) === null || _body$aggregations$ty === void 0 ? void 0 : _body$aggregations$ty.buckets) || []; // Initialise the object with all zeros for all the types
