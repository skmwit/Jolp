...
var _exportNames = {
  functionSpecs: true,
  mapColumn: true,
  MapColumnArguments: true,
  math: true,
  MathArguments: true,
  MathInput: true
};
Object.defineProperty(exports, "mapColumn", {
  enumerable: true,
  get: function () {
    return _map_column.mapColumn;
  }
});
Object.defineProperty(exports, "MapColumnArguments", {
  enumerable: true,
  get: function () {
    return _map_column.MapColumnArguments;
  }
});
...
Object.defineProperty(exports, "MathArguments", {
  enumerable: true,
  get: function () {
    return _math.MathArguments;
  }
});
Object.defineProperty(exports, "MathInput", {
  enumerable: true,
  get: function () {
    return _math.MathInput;
  }
});
...
var _map_column = require("./map_column");
 ...
 */
const functionSpecs = [_clog.clog, _font.font, _var_set.variableSet, _var.variable, _theme.theme, _cumulative_sum.cumulativeSum, _derivative.derivative, _moving_average.movingAverage, _map_column.mapColumn, _math.math];
