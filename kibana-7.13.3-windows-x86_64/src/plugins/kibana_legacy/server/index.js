...
const config = {
  ...
  renameFromRoot('kibana.defaultAppId', 'kibana_legacy.defaultAppId', {
    ...
    addDeprecation({
      ...
      correctiveActions: {
        manualSteps: ['Go to Stack Management > Advanced Settings', 'Update the "defaultRoute" setting under the General section', 'Remove "kibana.defaultAppId" from the kibana.yml config file']
      }
    });
    return completeConfig;
  }]
