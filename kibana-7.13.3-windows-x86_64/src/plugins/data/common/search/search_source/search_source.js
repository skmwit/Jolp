...
class SearchSource {
  ...
  inspectSearch(s$, options) {
    ...
    const last$ = s$.pipe((0, _operators.catchError)(e => {
      ...
      if (finalResponse) {
        requestResponder === null || requestResponder === void 0 ? void 0 : requestResponder.stats((0, _inspect.getResponseInspectorStats)(finalResponse, this));
  ...
  flatten() {
    ...
    const metaFields = getConfig(_common2.UI_SETTINGS.META_FIELDS); // get some special field types from the index pattern
