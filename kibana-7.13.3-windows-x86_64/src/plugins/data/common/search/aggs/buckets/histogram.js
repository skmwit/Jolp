...
const getHistogramBucketAgg = ({
  ...
  params: [{
    name: 'field',
    type: 'field',
    filterFieldTypes: [_common.KBN_FIELD_TYPES.NUMBER, _common.KBN_FIELD_TYPES.NUMBER_RANGE]
  }, {
    /*
    ...
    shouldShow(agg) {
      const field = agg.getField(); // Show this for empty field and number field, but not range
