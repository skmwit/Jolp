...
var _filters = require("../../es_query/filters");
...
const phraseFilterFunction = {
  ...
  fn(input, args) {
    if (args.phrase.length === 1) {
      return {
        type: 'kibana_filter',
        ...(0, _filters.buildFilter)({}, args.field.spec, _filters.FILTERS.PHRASE, args.negate || false, false, args.phrase[0], null)
      };
    }

    return {
      type: 'kibana_filter',
      ...(0, _filters.buildFilter)({}, args.field.spec, _filters.FILTERS.PHRASES, args.negate || false, false, args.phrase, null)
    };
  }
