...
var _es_query = require("../../es_query/es_query");
  ...
  const esdsl = {
    ...
    async fn(input, args, {
      ...
      if (input) {
        ...
        const query = (0, _es_query.buildEsQuery)(undefined, //        args.index,
      ...
      request.stats({
        indexPattern: {
          label: _i18n.i18n.translate('data.search.es_search.indexPatternLabel', {
