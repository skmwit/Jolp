...
class IndexPatternField {
  ...
  get type() {
    ...
    return (_this$runtimeField = this.runtimeField) !== null && _this$runtimeField !== void 0 && _this$runtimeField.type ? (0, _kbn_field_types.castEsToKbnFieldTypeName)((_this$runtimeField2 = this.runtimeField) === null || _this$runtimeField2 === void 0 ? void 0 : _this$runtimeField2.type) : this.spec.type;
  }
