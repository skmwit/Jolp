...
exports.updateMax = exports.updateMin = exports.minMaxAvgLoC = void 0;
...
function registerIndexPatternsUsageCollector(getStartServices, usageCollection) {
  ...
  const indexPatternUsageCollector = usageCollection.makeUsageCollector({
    ...
    fetch: async () => {
      ...
      const indexPatternService = await indexPatterns.indexPatternsServiceFactory(new _server.SavedObjectsClient(savedObjects.createInternalRepository()), elasticsearch.client.asInternalUser);
