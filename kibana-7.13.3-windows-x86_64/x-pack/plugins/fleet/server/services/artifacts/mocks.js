...
exports.setEsClientMethodResponseToError = exports.generateEsApiResponseMock = exports.generateArtifactEsSearchResultHitsMock = exports.generateArtifactEsGetSingleHitMock = exports.generateEsRequestErrorApiResponseMock = exports.generateArtifactMock = exports.createArtifactsClientMock = void 0;
...
const generateArtifactEsGetSingleHitMock = () => {
  const {
    id,
    created,
    ...newArtifact
  } = generateArtifactMock();
  const _source = { ...(0, _mappings.newArtifactToElasticsearchProperties)(newArtifact),
    created
  };
  return {
    _index: '.fleet-artifacts_1',
...
const setEsClientMethodResponseToError = (esClientMock, method, options) => {
  esClientMock[method].mockImplementation(() => {
    return _mocks.elasticsearchServiceMock.createErrorTransportRequestPromise(new _errors.ResponseError(generateEsRequestErrorApiResponseMock(options)));
  });
};
