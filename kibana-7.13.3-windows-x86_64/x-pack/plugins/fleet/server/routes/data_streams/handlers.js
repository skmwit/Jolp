...
const getListHandler = async (context, request, response) => {
  ...
  try {
    ...
    const allDashboardSavedObjectsResponse = await context.core.savedObjects.client.bulkGet(Object.values(dashboardIdsByPackageName).reduce((allDashboards, dashboardIds) => {
