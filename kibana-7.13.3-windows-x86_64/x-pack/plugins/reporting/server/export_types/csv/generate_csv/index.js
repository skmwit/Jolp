...
var _escape_value = require("../../csv_searchsource/generate_csv/escape_value");

var _max_size_string_builder = require("../../csv_searchsource/generate_csv/max_size_string_builder");
...
function createGenerateCsv(logger) {
  ...
  return async function generateCsv(job, config, uiSettingsClient, elasticsearchClient, cancellationToken) {
    ...
    const iterator = hitIterator(settings.scroll, elasticsearchClient, job.searchRequest, cancellationToken);
