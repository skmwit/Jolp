...
function getExportTypesRegistry() {
  ...
  const getTypeFns = [_csv_searchsource.getExportType, _csv.getExportType, _csv_searchsource_immediate.getExportType, _png.getExportType, _printable_pdf.getExportType];
