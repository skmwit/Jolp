...
const API_DIAGNOSE_URL = `${API_BASE_URL}/diagnose`; // hacky endpoint: download CSV without queueing a report

exports.API_DIAGNOSE_URL = API_DIAGNOSE_URL;
const API_BASE_URL_V1 = '/api/reporting/v1'; //

exports.API_BASE_URL_V1 = API_BASE_URL_V1;
const API_GENERATE_IMMEDIATE = `${API_BASE_URL_V1}/generate/immediate/csv_searchsource`; // Management UI route
