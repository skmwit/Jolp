...
var _create_endoint_event_filters_list = require("./create_endoint_event_filters_list");
...
class ExceptionListClient {
  constructor({
    ...
    _defineProperty(this, "createEndpointEventFiltersList", async () => {
      const {
        savedObjectsClient,
        user
      } = this;
      return (0, _create_endoint_event_filters_list.createEndpointEventFiltersList)({
        savedObjectsClient,
        user,
        version: 1
      });
