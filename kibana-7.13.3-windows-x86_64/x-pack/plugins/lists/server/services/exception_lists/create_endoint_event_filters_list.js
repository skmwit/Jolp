...
exports.createEndpointEventFiltersList = void 0;
...
const createEndpointEventFiltersList = async ({
  savedObjectsClient,
  user,
  tieBreaker,
  version
  ...
  try {
    const savedObject = await savedObjectsClient.create(savedObjectType, {
      ...
      id: _constants.ENDPOINT_EVENT_FILTERS_LIST_ID
    });
...
exports.createEndpointEventFiltersList = createEndpointEventFiltersList;