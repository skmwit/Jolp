...
function getTransactionsProjection({
  ...
  const bool = {
    filter: [...serviceNameFilter, ...transactionNameFilter, ...transactionTypeFilter, ...(0, _aggregated_transactions.getDocumentTypeFilterForAggregatedTransactions)(searchAggregatedTransactions), ...(0, _queries.rangeQuery)(start, end), ...(0, _queries.environmentQuery)(environment), ...(0, _queries.kqlQuery)(kuery)]
  };
  return {
    apm: {
