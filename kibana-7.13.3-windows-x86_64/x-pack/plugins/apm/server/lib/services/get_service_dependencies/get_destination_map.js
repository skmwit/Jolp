...
const getDestinationMap = ({
  ...
  return (0, _with_apm_span.withApmSpan)('get_service_destination_map', async () => {
    ...
    const outgoingConnections = (_response$aggregation = (_response$aggregation2 = response.aggregations) === null || _response$aggregation2 === void 0 ? void 0 : _response$aggregation2.connections.buckets.map(bucket => {
      var _fieldValues$SPAN_ID, _fieldValues$SPAN_TYP, _fieldValues$SPAN_SUB;
      ...
      return {
        ...
        [_elasticsearch_fieldnames.SPAN_ID]: (_fieldValues$SPAN_ID = fieldValues[_elasticsearch_fieldnames.SPAN_ID]) !== null && _fieldValues$SPAN_ID !== void 0 ? _fieldValues$SPAN_ID : '',
        [_elasticsearch_fieldnames.SPAN_TYPE]: (_fieldValues$SPAN_TYP = fieldValues[_elasticsearch_fieldnames.SPAN_TYPE]) !== null && _fieldValues$SPAN_TYP !== void 0 ? _fieldValues$SPAN_TYP : '',
        [_elasticsearch_fieldnames.SPAN_SUBTYPE]: (_fieldValues$SPAN_SUB = fieldValues[_elasticsearch_fieldnames.SPAN_SUBTYPE]) !== null && _fieldValues$SPAN_SUB !== void 0 ? _fieldValues$SPAN_SUB : ''
      };
    ...
    const transactionResponse = await (0, _with_apm_span.withApmSpan)('get_transactions_for_exit_spans', () => apmEventClient.search({
      ...
      body: {
        ...
        docvalue_fields: (0, _as_mutable_array.asMutableArray)([_elasticsearch_fieldnames.SERVICE_NAME, _elasticsearch_fieldnames.SERVICE_ENVIRONMENT, _elasticsearch_fieldnames.AGENT_NAME, _elasticsearch_fieldnames.PARENT_ID]),
        _source: false
      }
    }));
