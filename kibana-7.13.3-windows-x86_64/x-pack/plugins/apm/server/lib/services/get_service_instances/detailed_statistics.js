      ...
      previousPeriod: (0, _lodash.keyBy)(previousPeriod.map(data => {
        return { ...data,
          cpuUsage: (0, _offset_previous_period_coordinate.offsetPreviousPeriodCoordinates)({
            currentPeriodTimeseries: firtCurrentPeriod === null || firtCurrentPeriod === void 0 ? void 0 : firtCurrentPeriod.cpuUsage,
          ...
          memoryUsage: (0, _offset_previous_period_coordinate.offsetPreviousPeriodCoordinates)({
            currentPeriodTimeseries: firtCurrentPeriod === null || firtCurrentPeriod === void 0 ? void 0 : firtCurrentPeriod.memoryUsage,
