...
function getProfilingStats({
  ...
  return (0, _with_apm_span.withApmSpan)('get_profiling_stats', async () => {
...
function getProfilesWithStacks({
  ...
  return (0, _with_apm_span.withApmSpan)('get_profiles_with_stacks', async () => {
    ...
    const cardinalityResponse = await (0, _with_apm_span.withApmSpan)('get_top_cardinality', () => apmEventClient.search({
      apm: {
        events: [_processor_event.ProcessorEvent.profile]
      },
      body: {
    ...
    const allResponses = await (0, _with_apm_span.withApmSpan)('get_all_stacks', async () => {
      return Promise.all([...new Array(partitions)].map(async (_, num) => {
        ...
        const response = await (0, _with_apm_span.withApmSpan)('get_partition', () => apmEventClient.search({
          apm: {
            events: [_processor_event.ProcessorEvent.profile]
          },
          body: {
