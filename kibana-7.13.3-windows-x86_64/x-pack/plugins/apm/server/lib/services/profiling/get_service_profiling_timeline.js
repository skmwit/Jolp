...
var _queries2 = require("../../../utils/queries");
/*
...
async function getServiceProfilingTimeline({
  ...
  return (0, _with_apm_span.withApmSpan)('get_service_profiling_timeline', async () => {
    const {
      apmEventClient,
      start,
      end
      ...
      body: {
        ...
        query: {
          bool: {
            ...
            }, ...(0, _queries.rangeQuery)(start, end), ...(0, _queries.environmentQuery)(environment), ...(0, _queries2.kqlQuery)(kuery)]
          }
        },
        aggs: {
          timeseries: {
