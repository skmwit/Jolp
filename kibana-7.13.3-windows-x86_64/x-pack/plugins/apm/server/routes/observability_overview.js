...
const observabilityOverviewHasDataRoute = (0, _create_apm_server_route.createApmServerRoute)({
  ...
  handler: async resources => {
    ...
    const res = await (0, _has_data.getHasData)({
      setup
    });
    return {
      hasData: res
...
const observabilityOverviewRouteRepository = (0, _create_apm_server_route_repository.createApmServerRouteRepository)().add(observabilityOverviewRoute).add(observabilityOverviewHasDataRoute);
