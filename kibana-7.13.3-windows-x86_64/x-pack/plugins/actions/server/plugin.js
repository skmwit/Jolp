...
class ActionsPlugin {
  constructor(initContext) {
    ...
    this.actionsConfig = (0, _config.getValidatedConfig)(this.logger, initContext.config.get());
  ...
  setup(core, plugins) {
    ...
    (0, _routes.defineRoutes)(core.http.createRouter(), this.licenseState); // Cleanup failed execution task definition
