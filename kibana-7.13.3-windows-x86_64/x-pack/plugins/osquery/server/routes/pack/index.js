...
const initPackRoutes = router => {
  (0, _create_pack_route.createPackRoute)(router);
  (0, _delete_pack_route.deletePackRoute)(router);
  (0, _find_pack_route.findPackRoute)(router);
  (0, _read_pack_route.readPackRoute)(router);
  (0, _update_pack_route.updatePackRoute)(router);
};
