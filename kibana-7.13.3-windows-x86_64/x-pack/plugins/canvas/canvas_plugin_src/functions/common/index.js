...
const functions = [_all.all, _alterColumn.alterColumn, _any.any, _as.asFn, _axisConfig.axisConfig, _clear.clear, _columns.columns, _compare.compare, _containerStyle.containerStyle, _context.context, _csv.csv, _date.date, _do.doFn, _dropdownControl.dropdownControl, _eq.eq, _exactly.exactly, _filterrows.filterrows, _formatdate.formatdate, _formatnumber.formatnumber, _getCell.getCell, _gt.gt, _gte.gte, _head.head, _if.ifFn, _image.image, _lt.lt, _lte.lte, _join_rows.joinRows, _map_center.mapCenter, _metric.metric, _neq.neq, _ply.ply, _progress.progress, _render.render, _repeat_image.repeatImage, _replace.replace, _revealImage.revealImage, _rounddate.rounddate, _rowCount.rowCount, _seriesStyle.seriesStyle, _shape.shape, _sort.sort, _staticColumn.staticColumn, _string.string, _table.table, _tail.tail, _timefilter.timefilter, _timefilterControl.timefilterControl, _time_range.timerange, _switch.switchFn, _case.caseFn];
