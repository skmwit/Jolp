...
exports.isCommentAlert = exports.isCommentGeneratedAlert = exports.externalServiceFormatters = exports.registerConnectors = exports.separator = void 0;
...
const isCommentGeneratedAlert = comment => {
  return comment.type === _api.CommentType.generatedAlert && 'alerts' in comment && comment.alerts !== undefined;
};

exports.isCommentGeneratedAlert = isCommentGeneratedAlert;

const isCommentAlert = comment => {
  return comment.type === _api.CommentType.alert;
};
