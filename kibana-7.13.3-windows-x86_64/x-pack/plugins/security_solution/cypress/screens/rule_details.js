...
const FIELDS_BROWSER_BTN = '[data-test-subj="events-viewer-panel"] [data-test-subj="show-field-browser"]';
exports.FIELDS_BROWSER_BTN = FIELDS_BROWSER_BTN;
...
const TIMELINE_FIELD = field => {
  return `[data-test-subj="draggable-content-${field}"]`;
};

exports.TIMELINE_FIELD = TIMELINE_FIELD;
