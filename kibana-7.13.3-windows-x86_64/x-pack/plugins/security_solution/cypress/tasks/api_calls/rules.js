...
const createCustomRule = (rule, ruleId = 'rule_testing', interval = '100m') => cy.request({
  method: 'POST',
...
const createCustomRuleActivated = (rule, ruleId = '1', interval = '100m', maxSignals = 500) => cy.request({
  method: 'POST',
  url: 'api/detection_engine/rules',
  body: {
    rule_id: ruleId,
