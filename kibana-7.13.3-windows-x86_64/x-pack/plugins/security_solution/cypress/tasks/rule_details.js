...
exports.goBackToAllRulesTable = exports.waitForTheRuleToBeExecuted = exports.removeException = exports.goToExceptionsTab = exports.goToAlertsTab = exports.addsExceptionFromRuleSettings = exports.openExceptionModalFromRuleSettings = exports.addsFieldsToTimeline = exports.addsException = exports.activatesRule = void 0;
...
const addsFieldsToTimeline = (search, fields) => {
  cy.get(_rule_details.FIELDS_BROWSER_BTN).click();
  (0, _fields_browser.filterFieldsBrowser)(search);
  (0, _fields_browser.addsFields)(fields);
  (0, _fields_browser.closeFieldsBrowser)();
};

exports.addsFieldsToTimeline = addsFieldsToTimeline;
