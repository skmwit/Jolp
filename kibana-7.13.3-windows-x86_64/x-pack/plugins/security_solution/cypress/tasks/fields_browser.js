...
exports.resetFields = exports.removesMessageField = exports.filterFieldsBrowser = exports.closeFieldsBrowser = exports.clearFieldsBrowser = exports.addsHostGeoCountryNameToTimelineDraggingIt = exports.addsHostGeoContinentNameToTimeline = exports.addsHostGeoCityNameToTimeline = exports.addsFields = void 0;
...
const addsFields = fields => {
  fields.forEach(field => {
    cy.get((0, _fields_browser.FIELDS_BROWSER_CHECKBOX)(field)).click();
  });
};

exports.addsFields = addsFields;
...
const closeFieldsBrowser = () => {
  cy.get(_fields_browser.CLOSE_BTN).click({
    force: true
  });
};
