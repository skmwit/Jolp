...
exports.waitForKibana = exports.goBackToRuleDetails = exports.saveEditedRule = void 0;
...
const goBackToRuleDetails = () => {
  cy.get(_edit_rule.BACK_TO_RULE_DETAILS).should('exist').click();
  cy.get(_edit_rule.BACK_TO_RULE_DETAILS).should('not.exist');
};

exports.goBackToRuleDetails = goBackToRuleDetails;
