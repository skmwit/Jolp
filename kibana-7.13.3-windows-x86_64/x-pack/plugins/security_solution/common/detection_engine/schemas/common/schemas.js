...
var _normalized_ml_job_id = require("../types/normalized_ml_job_id");
...
const machine_learning_job_id = t.union([t.string, _normalized_ml_job_id.machine_learning_job_id_normalized]);
