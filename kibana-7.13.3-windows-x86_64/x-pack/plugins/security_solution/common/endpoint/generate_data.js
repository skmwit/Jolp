...
exports.getTreeOptionsWithDef = getTreeOptionsWithDef;
exports.EndpointDocGenerator = exports.categoryMapping = exports.RelatedEventCategory = exports.ECSCategory = exports.ANCESTRY_LIMIT = void 0;
...
var _base_data_generator = require("./data_generators/base_data_generator");
...
const ANCESTRY_LIMIT = 2;
exports.ANCESTRY_LIMIT = ANCESTRY_LIMIT;
const Windows = [{
  name: 'windows 10.0',
  full: 'Windows 10',
  version: '10.0',
...
const POLICY_RESPONSE_STATUSES = [_types.HostPolicyResponseActionStatus.success, _types.HostPolicyResponseActionStatus.failure, _types.HostPolicyResponseActionStatus.warning, _types.HostPolicyResponseActionStatus.unsupported];
...
const FILE_OPERATIONS = ['creation', 'open', 'rename', 'execution', 'deletion'];
/**
...
exports.ECSCategory = ECSCategory;

(function (ECSCategory) {
  ECSCategory["Driver"] = "driver";
  ECSCategory["File"] = "file";
  ECSCategory["Network"] = "network";
  ECSCategory["Registry"] = "registry";
  ECSCategory["Authentication"] = "authentication";
  ECSCategory["Session"] = "session";
})(ECSCategory || (exports.ECSCategory = ECSCategory = {}));

let RelatedEventCategory;
/**
...
exports.RelatedEventCategory = RelatedEventCategory;

(function (RelatedEventCategory) {
  RelatedEventCategory["Random"] = "random";
  RelatedEventCategory["Driver"] = "driver";
  RelatedEventCategory["File"] = "file";
  RelatedEventCategory["Network"] = "network";
  RelatedEventCategory["Registry"] = "registry";
  RelatedEventCategory["Security"] = "security";
})(RelatedEventCategory || (exports.RelatedEventCategory = RelatedEventCategory = {}));
...
exports.categoryMapping = categoryMapping; // These are from the v1 schemas and aren't all valid ECS event categories, still in flux
...
function getTreeOptionsWithDef(options) {
  var _options$ancestors, _options$generations, _options$children, _options$relatedEvent, _options$relatedEvent2, _options$relatedAlert, _options$percentWithR, _options$percentTermi, _options$alwaysGenMax, _options$ancestryArra, _options$eventsDataSt, _options$alertsDataSt;

  return {
    ancestors: (_options$ancestors = options === null || options === void 0 ? void 0 : options.ancestors) !== null && _options$ancestors !== void 0 ? _options$ancestors : 3,
    generations: (_options$generations = options === null || options === void 0 ? void 0 : options.generations) !== null && _options$generations !== void 0 ? _options$generations : 2,
    children: (_options$children = options === null || options === void 0 ? void 0 : options.children) !== null && _options$children !== void 0 ? _options$children : 2,
    relatedEvents: (_options$relatedEvent = options === null || options === void 0 ? void 0 : options.relatedEvents) !== null && _options$relatedEvent !== void 0 ? _options$relatedEvent : 5,
    relatedEventsOrdered: (_options$relatedEvent2 = options === null || options === void 0 ? void 0 : options.relatedEventsOrdered) !== null && _options$relatedEvent2 !== void 0 ? _options$relatedEvent2 : false,
    relatedAlerts: (_options$relatedAlert = options === null || options === void 0 ? void 0 : options.relatedAlerts) !== null && _options$relatedAlert !== void 0 ? _options$relatedAlert : 3,
    percentWithRelated: (_options$percentWithR = options === null || options === void 0 ? void 0 : options.percentWithRelated) !== null && _options$percentWithR !== void 0 ? _options$percentWithR : 30,
    percentTerminated: (_options$percentTermi = options === null || options === void 0 ? void 0 : options.percentTerminated) !== null && _options$percentTermi !== void 0 ? _options$percentTermi : 100,
    alwaysGenMaxChildrenPerNode: (_options$alwaysGenMax = options === null || options === void 0 ? void 0 : options.alwaysGenMaxChildrenPerNode) !== null && _options$alwaysGenMax !== void 0 ? _options$alwaysGenMax : false,
    ancestryArraySize: (_options$ancestryArra = options === null || options === void 0 ? void 0 : options.ancestryArraySize) !== null && _options$ancestryArra !== void 0 ? _options$ancestryArra : ANCESTRY_LIMIT,
    eventsDataStream: (_options$eventsDataSt = options === null || options === void 0 ? void 0 : options.eventsDataStream) !== null && _options$eventsDataSt !== void 0 ? _options$eventsDataSt : eventsDefaultDataStream,
    alertsDataStream: (_options$alertsDataSt = options === null || options === void 0 ? void 0 : options.alertsDataStream) !== null && _options$alertsDataSt !== void 0 ? _options$alertsDataSt : alertsDefaultDataStream
  };
}
...
class EndpointDocGenerator extends _base_data_generator.BaseDataGenerator {
  /**
  ...
  constructor(seed = Math.random().toString()) {
    ...
    _defineProperty(this, "commonInfo", void 0);

    _defineProperty(this, "sequence", 0);
  ...
  static createDataStreamFromIndex(index) {
  ...
  generateHostMetadata(ts = new Date().getTime(), metadataDataStream = metadataDefaultDataStream) {
    return {
      '@timestamp': ts,
      event: {
        created: ts,
  ...
  generateEvent(options = {}) {
    var _options$ancestry$sli, _options$ancestry, _options$ancestryArra2, _options$eventsDataSt2; // this will default to an empty array for the ancestry field if options.ancestry isn't included


    const ancestry = (_options$ancestry$sli = (_options$ancestry = options.ancestry) === null || _options$ancestry === void 0 ? void 0 : _options$ancestry.slice(0, (_options$ancestryArra2 = options === null || options === void 0 ? void 0 : options.ancestryArrayLimit) !== null && _options$ancestryArra2 !== void 0 ? _options$ancestryArra2 : ANCESTRY_LIMIT)) !== null && _options$ancestry$sli !== void 0 ? _options$ancestry$sli : [];
    ...
    const detailRecordForEventType = options.extensions || (eventCategory => {
      if (eventCategory === 'registry') {
        return {
          registry: {
            key: `HKLM/Windows/Software/${this.randomString(5)}`
          }
        };
      }
      ...
      if (eventCategory === 'file') {
        return {
          file: {
            path: 'C:\\My Documents\\business\\January\\processName'
          }
        };
      }
    ...
    return {
      data_stream: (_options$eventsDataSt2 = options === null || options === void 0 ? void 0 : options.eventsDataStream) !== null && _options$eventsDataSt2 !== void 0 ? _options$eventsDataSt2 : eventsDefaultDataStream,
      ...
      process: {
        pid: 'pid' in options && typeof options.pid !== 'undefined' ? options.pid : this.randomN(5000),
        ...
        parent: options.parentEntityID ? {
          ...
          pid: 'parentPid' in options && typeof options.parentPid !== 'undefined' ? options.parentPid : this.randomN(5000)
        } : undefined,
        name: processName,
  ...
  static getStartEndTimes(events) {
    let startTime;
    let endTime;
    ...
    if (events.length > 0) {
      ...
      startTime = (_timestampSafeVersion = (0, _event.timestampSafeVersion)(events[0])) !== null && _timestampSafeVersion !== void 0 ? _timestampSafeVersion : new Date().getTime();
      endTime = startTime;
    } else {
    ...
    for (const event of events) {
      const eventTimestamp = (0, _event.timestampSafeVersion)(event);
  ...
  generateTree(options = {}) {
    ...
    const addEventToMap = (nodeMap, event) => {
      var _event$event, _event$event3;

      const nodeID = (0, _event.entityIDSafeVersion)(event);
      ...
      if ((0, _ecs_safety_helpers.firstNonNullValue)((_event$event = event.event) === null || _event$event === void 0 ? void 0 : _event$event.kind) === 'event') {
        var _event$event2;

        if ((0, _ecs_safety_helpers.firstNonNullValue)((_event$event2 = event.event) === null || _event$event2 === void 0 ? void 0 : _event$event2.category) === 'process') {
          node.lifecycle.push(event);
        } else {
          node.relatedEvents.push(event);
        }
      } else if ((0, _ecs_safety_helpers.firstNonNullValue)((_event$event3 = event.event) === null || _event$event3 === void 0 ? void 0 : _event$event3.kind) === 'alert') {
    ...
    const groupNodesByParent = children => {
      const nodesByParent = new Map();

      for (const node of children.values()) {
        const parentID = (0, _event.parentEntityIDSafeVersion)(node.lifecycle[0]);
    ...
    const createLevels = (childrenByParent, levels, currentNodes) => {
    ...
    const ancestry = this.createAlertEventAncestry(optionsWithDef); // create a mapping of entity_id -> {lifecycle, related events, and related alerts}

    const ancestryNodes = ancestry.reduce(addEventToMap, new Map());
    const alert = ancestry[ancestry.length - 1];
    const alertEntityID = (0, _event.entityIDSafeVersion)(alert);
    ...
    const childrenNodes = children.reduce(addEventToMap, new Map());
    ...
    const {
      startTime,
      endTime
    } = EndpointDocGenerator.getStartEndTimes(allEvents);
    return {
      childrenByParent,
  ...
  *alertsGenerator(numAlerts, options = {}) {
  ...
  *fullResolverTreeGenerator(options = {}) {
    const opts = getTreeOptionsWithDef(options);
  ...
  createAlertEventAncestry(options = {}) {
    var _timestampSafeVersion2;
    ...
    events.push(root);
    let ancestor = root;
    let timestamp = ((_timestampSafeVersion2 = (0, _event.timestampSafeVersion)(root)) !== null && _timestampSafeVersion2 !== void 0 ? _timestampSafeVersion2 : 0) + 1000;

    const addRelatedAlerts = (node, alertsPerNode, secBeforeAlert, eventList) => {
    ...
    const addRelatedEvents = (node, secBeforeEvent, eventList) => {
    ...
    if (this.randomN(100) < opts.percentTerminated) {
      ...
      events.push(this.generateEvent({
        ...
        entityID: (0, _event.entityIDSafeVersion)(root),
        parentEntityID: (0, _event.parentEntityIDSafeVersion)(root),
        eventCategory: ['process'],
        eventType: ['end'],
        eventsDataStream: opts.eventsDataStream,
        processName: (0, _event.processNameSafeVersion)(root)
      }));
    }

    for (let i = 0; i < opts.ancestors; i++) {
      var _ancestryArray, _ancestor$process;

      const ancestorEntityID = (0, _event.entityIDSafeVersion)(ancestor);
      const ancestry = [];
      ...
      ancestry.push(...((_ancestryArray = (0, _event.ancestryArray)(ancestor)) !== null && _ancestryArray !== void 0 ? _ancestryArray : []));
      ancestor = this.generateEvent({
        timestamp,
        parentEntityID: (0, _event.entityIDSafeVersion)(ancestor),
        // add the parent to the ancestry array
        ancestry,
        ancestryArrayLimit: opts.ancestryArraySize,
        parentPid: (0, _ecs_safety_helpers.firstNonNullValue)((_ancestor$process = ancestor.process) === null || _ancestor$process === void 0 ? void 0 : _ancestor$process.pid),
      ...
      if (this.randomN(100) < opts.percentTerminated) {
        ...
        events.push(this.generateEvent({
          timestamp: timestamp + termProcessDuration * 1000,
          entityID: (0, _event.entityIDSafeVersion)(ancestor),
          parentEntityID: (0, _event.parentEntityIDSafeVersion)(ancestor),
          eventCategory: ['process'],
          eventType: ['end'],
          ancestry: (0, _event.ancestryArray)(ancestor),
          ancestryArrayLimit: opts.ancestryArraySize,
          eventsDataStream: opts.eventsDataStream,
          processName: (0, _event.processNameSafeVersion)(ancestor)
        }));
      ...
      if (this.randomN(100) < opts.percentWithRelated) {
        addRelatedEvents(ancestor, processDuration, events);
        let numAlertsPerNode = opts.relatedAlerts; // if this is the last ancestor, create one less related alert so that we have a uniform amount of related alerts
    ...
    timestamp = timestamp + 1000;
    events.push(this.generateAlert({
      ts: timestamp,
      entityID: (0, _event.entityIDSafeVersion)(ancestor),
      parentEntityID: (0, _event.parentEntityIDSafeVersion)(ancestor),
      ancestry: (0, _event.ancestryArray)(ancestor),
  ...
  *descendantsTreeGenerator(root, options = {}) {
    var _timestampSafeVersion3;
    ...
    const lineage = [rootState];
    let timestamp = (_timestampSafeVersion3 = (0, _event.timestampSafeVersion)(root)) !== null && _timestampSafeVersion3 !== void 0 ? _timestampSafeVersion3 : 0;

    while (lineage.length > 0) {
      var _ancestryArray2;

      const currentState = lineage[lineage.length - 1]; // If we get to a state node and it has made all the children, move back up a level

      if (currentState.childrenCreated === currentState.maxChildren || lineage.length === opts.generations + 1) {
        lineage.pop(); // eslint-disable-next-line no-continue
      ...
      timestamp = timestamp + 1000;
      const currentStateEntityID = (0, _event.entityIDSafeVersion)(currentState.event);
      const ancestry = [];
      ...
      ancestry.push(...((_ancestryArray2 = (0, _event.ancestryArray)(currentState.event)) !== null && _ancestryArray2 !== void 0 ? _ancestryArray2 : []));
      ...
      if (this.randomN(100) < opts.percentTerminated) {
        ...
        yield this.generateEvent({
          ...
          entityID: (0, _event.entityIDSafeVersion)(child),
          parentEntityID: (0, _event.parentEntityIDSafeVersion)(child),
          eventCategory: ['process'],
          eventType: ['end'],
          ancestry,
          ancestryArrayLimit: opts.ancestryArraySize,
  ...
  *relatedEventsGenerator({
    ...
    var _timestampSafeVersion4;

    let relatedEventsInfo;
    const nodeTimestamp = (_timestampSafeVersion4 = (0, _event.timestampSafeVersion)(node)) !== null && _timestampSafeVersion4 !== void 0 ? _timestampSafeVersion4 : 0;
    let ts = nodeTimestamp + 1;

    if (typeof relatedEvents === 'number') {
      relatedEventsInfo = [{
        category: RelatedEventCategory.Random,
        count: relatedEvents
      }];
    } else {
    ...
    for (const event of relatedEventsInfo) {
      ...
      for (let i = 0; i < event.count; i++) {
        ...
        yield this.generateEvent({
          timestamp: ts,
          entityID: (0, _event.entityIDSafeVersion)(node),
          parentEntityID: (0, _event.parentEntityIDSafeVersion)(node),
          eventCategory: eventInfo.category,
          eventType: eventInfo.creationType,
          ancestry: (0, _event.ancestryArray)(node),
          eventsDataStream
        });
      }
    }
  ...
  *relatedAlertsGenerator({
    ...
    for (let i = 0; i < relatedAlerts; i++) {
      var _timestampSafeVersion5;

      const ts = ((_timestampSafeVersion5 = (0, _event.timestampSafeVersion)(node)) !== null && _timestampSafeVersion5 !== void 0 ? _timestampSafeVersion5 : 0) + this.randomN(alertCreationTime) * 1000;
  ...
  generateAgentPolicy() {
    return {
      id: this.seededUUIDv4(),
      name: 'Agent Policy',
      status: _constants.agentPolicyStatuses.Active,
      ...
      savedObject: {
        ...
        attributes: {
          ...
          installed_es: [{
            ...
            id: 'metrics-endpoint.metadata_mirror',
            type: 'index_template'
          }, {
        ...
        policy: {
          applied: {
            actions: [{
              ...
              status: _types.HostPolicyResponseActionStatus.unsupported
            }, {
              name: 'download_model',
              message: 'Failed to apply a portion of the configuration (kernel)',
              status: _types.HostPolicyResponseActionStatus.success
            ...
            endpoint_policy_version: this.commonInfo.Endpoint.policy.applied.endpoint_policy_version
          }
        }
      },
      event: {
  ...
  randomHostPolicyResponseActionNames() {
    return this.randomArray(this.randomN(8), () => this.randomChoice(['load_config', 'workflow', 'download_global_artifacts', 'configure_malware', 'read_malware_config', 'load_malware_model', 'read_kernel_config', 'configure_kernel', 'detect_process_events', 'detect_file_write_events', 'detect_file_open_events', 'detect_image_load_events', 'connect_kernel']));
  }
...
exports.EndpointDocGenerator = EndpointDocGenerator;
const fakeProcessNames = ['lsass.exe', 'notepad.exe', 'mimikatz.exe', 'powershell.exe', 'iexlorer.exe', 'explorer.exe'];