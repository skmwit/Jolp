...
class Plugin {
  ...
  setup(core, plugins) {
    ...
    const endpointContext = {
      ...
      experimentalFeatures: (0, _experimental_features.parseExperimentalConfigValue)(config.enableExperimental)
    };
    ...
    (0, _kibana.compose)(core, plugins, endpointContext);
  ...
  start(core, plugins) {
    ...
    if (this.lists && plugins.taskManager && plugins.fleet) {
      ...
      const experimentalFeatures = (0, _experimental_features.parseExperimentalConfigValue)(this.config.enableExperimental);
