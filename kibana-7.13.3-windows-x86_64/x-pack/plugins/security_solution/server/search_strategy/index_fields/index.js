...
exports.formatIndexFields = exports.formatSecondFields = exports.formatFirstFields = exports.createFieldItem = exports.dedupeIndexName = exports.requestIndexFieldSearch = exports.securitySolutionIndexFieldsProvider = void 0;
...
const securitySolutionIndexFieldsProvider = () => {
  ...
  return {
    search: (request, options, deps) => (0, _rxjs.from)(requestIndexFieldSearch(request, deps, beatFields))
  };
};
...
const requestIndexFieldSearch = async (request, {
  ...
  const responsesIndexFields = await Promise.all(dedupeIndices.map(async index => {
    if (request.onlyCheckIfIndicesExist && index.includes(apmIndexPattern)) {
      ...
      return (0, _get.default)(searchResponse, 'body.hits.total.value', 0) > 0;
    } else {
