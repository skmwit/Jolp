...
const getEndpointTelemetryFromFleet = async (soClient, endpointAppContext, esClient) => {
  ...
  try {
    ...
    const response = await (0, _fleet_saved_objects.getEndpointIntegratedFleetMetadata)(agentService, esClient);
    endpointAgents = (_response$agents = response === null || response === void 0 ? void 0 : response.agents) !== null && _response$agents !== void 0 ? _response$agents : [];
  } catch (error) {
