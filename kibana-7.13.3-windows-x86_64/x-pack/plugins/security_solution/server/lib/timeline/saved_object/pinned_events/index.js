...
exports.pickSavedPinnedEvent = exports.convertSavedObjectToSavedPinnedEvent = exports.savePinnedEvents = exports.persistPinnedEventOnTimeline = exports.getAllPinnedEvents = exports.getAllPinnedEventsByTimelineId = exports.getPinnedEvent = exports.deleteAllPinnedEventsOnTimeline = exports.deletePinnedEventOnTimeline = void 0;
...
var _timelines2 = require("../timelines");
  ...
  try {
    if (pinnedEventId == null) {
      const timelineVersionSavedObject = timelineId == null ? await (async () => {
        const timelineResult = (0, _timelines2.convertSavedObjectToSavedTimeline)(await savedObjectsClient.create(_saved_object_mappings.timelineSavedObjectType, (0, _timelines.pickSavedTimeline)(null, {}, request.user || null)));
      ...
      if (timelineId != null) {
        ...
        if (isPinnedAlreadyExisting.length === 0) {
          ...
          return convertSavedObjectToSavedPinnedEvent(await savedObjectsClient.create(_pinned_events.pinnedEventSavedObjectType, pickSavedPinnedEvent(pinnedEventId, savedPinnedEvent, request.user || null)), timelineVersionSavedObject != null ? timelineVersionSavedObject : undefined);
        }
