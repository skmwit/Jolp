...
exports.getSelectedTimelines = exports.timelineWithReduxProperties = exports.convertStringToBase64 = exports.deleteTimeline = exports.resetTimeline = exports.persistTimeline = exports.persistFavorite = exports.getDraftTimeline = exports.getAllTimeline = exports.getExistingPrepackagedTimelines = exports.getTimelineTemplateOrNull = exports.getTimelineByTemplateTimelineId = exports.getTimelineOrNull = exports.getTimeline = void 0;
...
const getAllTimeline = async (request, onlyUserFavorite, pageInfo, search, sort, status, timelineType) => {
  ...
  const favoriteTimelineOptions = {
    ...
    perPage: 1,
    page: 1,
    filter: getTimelineTypeFilter(timelineType !== null && timelineType !== void 0 ? timelineType : null, _timeline.TimelineStatus.active)
  };
