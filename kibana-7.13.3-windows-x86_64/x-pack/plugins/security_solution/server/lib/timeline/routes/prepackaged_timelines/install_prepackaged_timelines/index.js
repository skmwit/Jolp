...
const installPrepackedTimelinesRoute = (router, config, security) => {
  router.post({
    ...
    try {
      ...
      const [validatedprepackagedTimelineStatus, prepackagedTimelineStatusError] = (0, _validate.validate)(prepackagedTimelineStatus, _check_timelines_status.checkTimelineStatusRt);
