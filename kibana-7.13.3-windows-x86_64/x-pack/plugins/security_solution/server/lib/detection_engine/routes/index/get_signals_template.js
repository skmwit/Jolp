...
const SIGNALS_TEMPLATE_VERSION = 35;
  ...
  const template = {
    ...
    mappings: {
      ...
      properties: { ..._ecs_mapping.default.mappings.properties,
        ..._other_mappings.default.mappings.properties,
        signal: _signals_mapping.default.mappings.properties.signal,
        threat: { ..._ecs_mapping.default.mappings.properties.threat,
          properties: { ..._ecs_mapping.default.mappings.properties.threat.properties,
            indicator: { ..._other_mappings.default.mappings.properties.threat.properties.indicator,
              properties: { ..._other_mappings.default.mappings.properties.threat.properties.indicator.properties,
                event: _ecs_mapping.default.mappings.properties.event
              }
            }
          }
        }
