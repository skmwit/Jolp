...
const createDetectionIndex = async (context, siemClient) => {
  ...
  if (!policyExists) {
    await (0, _set_policy.setPolicy)(esClient, index, _signals_policy.default);
  }
  ...
  if (await (0, _check_template_version.templateNeedsUpdate)({
    ...
    await (0, _set_template.setTemplate)(esClient, index, (0, _get_signals_template.getSignalsTemplate)(index));
  }
  ...
  if (indexExists) {
    ...
    await (0, _create_bootstrap_index.createBootstrapIndex)(esClient, index);
  }
};
