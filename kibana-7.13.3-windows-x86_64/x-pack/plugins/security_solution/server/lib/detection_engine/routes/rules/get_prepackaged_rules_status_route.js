...
var _rule_asset_saved_objects_client = require("../../rules/rule_asset_saved_objects_client");
...
const getPrepackagedRulesStatusRoute = (router, config, security) => {
  router.get({
    ...
    try {
      ...
      const latestPrepackagedRules = await (0, _get_prepackaged_rules.getLatestPrepackagedRules)(ruleAssetsClient);
      ...
      const [validatedprepackagedTimelineStatus] = (0, _validate.validate)(prepackagedTimelineStatus, _check_timelines_status.checkTimelineStatusRt);
