...
const patchRules = async ({
  ...
  const nextParams = (0, _fp.defaults)({ ...rule.params
    ...
    severityMapping,
    threat,
    threshold: threshold ? (0, _utils2.normalizeThresholdObject)(threshold) : undefined,
    threatFilters,
    threatIndex,
    threatQuery,
    threatMapping,
    ...
    exceptionsList,
    anomalyThreshold,
    machineLearningJobId: machineLearningJobId ? (0, _utils2.normalizeMachineLearningJobIds)(machineLearningJobId) : undefined
  });
  const newRule = {
