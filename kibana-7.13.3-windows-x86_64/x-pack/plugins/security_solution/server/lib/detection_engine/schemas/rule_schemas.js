...
exports.internalRuleResponse = exports.internalRuleUpdate = exports.internalRuleCreate = exports.ruleParams = exports.typeSpecificRuleParams = exports.machineLearningRuleParams = exports.thresholdRuleParams = exports.savedQueryRuleParams = exports.queryRuleParams = exports.threatRuleParams = exports.eqlRuleParams = exports.baseRuleParams = void 0;
...
var _normalized_ml_job_id = require("../../../../common/detection_engine/schemas/types/normalized_ml_job_id");
...
const baseRuleParams = t.exact(t.type({
  ...
  riskScoreMapping: _schemas.risk_score_mapping,
  ruleNameOverride: _schemas.ruleNameOverrideOrUndefined,
  severity: _schemas.severity,
  severityMapping: _schemas.severity_mapping,
  ...
  exceptionsList: _lists.listArray
}));
...
const machineLearningSpecificRuleParams = t.type({
  ...
  machineLearningJobId: _normalized_ml_job_id.machine_learning_job_id_normalized
});
