...
exports.internalRuleToAPIResponse = exports.commonParamsCamelToSnake = exports.typeSpecificCamelToSnake = exports.convertCreateAPIToInternalSchema = exports.typeSpecificSnakeToCamel = void 0;
...
const internalRuleToAPIResponse = (rule, ruleActions, ruleStatus) => {
  var _rule$updatedBy, _rule$createdBy, _ruleActions$actions, _ruleStatus$attribute, _ruleStatus$attribute2, _ruleStatus$attribute3, _ruleStatus$attribute4, _ruleStatus$attribute5, _ruleStatus$attribute6;
  ...
  return {
    ...
    status_date: (_ruleStatus$attribute2 = ruleStatus === null || ruleStatus === void 0 ? void 0 : ruleStatus.attributes.statusDate) !== null && _ruleStatus$attribute2 !== void 0 ? _ruleStatus$attribute2 : undefined,
    last_failure_at: (_ruleStatus$attribute3 = ruleStatus === null || ruleStatus === void 0 ? void 0 : ruleStatus.attributes.lastFailureAt) !== null && _ruleStatus$attribute3 !== void 0 ? _ruleStatus$attribute3 : undefined,
    last_success_at: (_ruleStatus$attribute4 = ruleStatus === null || ruleStatus === void 0 ? void 0 : ruleStatus.attributes.lastSuccessAt) !== null && _ruleStatus$attribute4 !== void 0 ? _ruleStatus$attribute4 : undefined,
    last_failure_message: (_ruleStatus$attribute5 = ruleStatus === null || ruleStatus === void 0 ? void 0 : ruleStatus.attributes.lastFailureMessage) !== null && _ruleStatus$attribute5 !== void 0 ? _ruleStatus$attribute5 : undefined,
    last_success_message: (_ruleStatus$attribute6 = ruleStatus === null || ruleStatus === void 0 ? void 0 : ruleStatus.attributes.lastSuccessMessage) !== null && _ruleStatus$attribute6 !== void 0 ? _ruleStatus$attribute6 : undefined
  };
};
