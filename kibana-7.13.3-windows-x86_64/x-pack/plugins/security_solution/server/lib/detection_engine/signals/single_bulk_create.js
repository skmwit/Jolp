...
const filterDuplicateRules = (ruleId, signalSearchResponse) => {
  return signalSearchResponse.hits.hits.filter(doc => {
    ...
    if (((_doc$_source = doc._source) === null || _doc$_source === void 0 ? void 0 : _doc$_source.signal) == null || !(0, _build_event_type_signal.isEventTypeSignal)(doc)) {
      return true;
    } else {
      var _doc$_source2, _doc$_source3;

      return !((_doc$_source2 = doc._source) !== null && _doc$_source2 !== void 0 && _doc$_source2.signal.ancestors.some(ancestor => ancestor.rule === ruleId) || ((_doc$_source3 = doc._source) === null || _doc$_source3 === void 0 ? void 0 : _doc$_source3.signal.rule.id) === ruleId);
    }
  });
};
/**
...
const singleBulkCreate = async ({
  ...
  const bulkBody = filteredEvents.hits.hits.flatMap(doc => {
    ...
    }, (0, _build_bulk_body.buildBulkBody)(ruleSO, doc)];
  });
