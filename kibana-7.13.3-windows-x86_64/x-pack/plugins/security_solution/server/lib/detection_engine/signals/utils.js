...
const checkPrivileges = async (services, indices) => (await services.scopedClusterClient.asCurrentUser.transport.request({
...
const lastValidDate = ({
  ...
  if (searchResult.hits.hits.length === 0) {
    ...
    const timestampValue = lastRecord.fields != null && lastRecord.fields[timestamp] != null ? lastRecord.fields[timestamp][0] : // @ts-expect-error @elastic/elasticsearch _source is optional
