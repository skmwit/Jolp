...
exports.updatedTrustedAppToUpdateExceptionListItemOptions = exports.newTrustedAppToCreateExceptionListItemOptions = exports.conditionEntriesToEntries = exports.effectScopeToTags = exports.createEntryNested = exports.createEntryMatch = exports.osFromExceptionItem = exports.exceptionListItemToTrustedApp = exports.entriesToConditionEntriesMap = exports.tagsToEffectScope = exports.createConditionEntry = void 0;
...
const newTrustedAppToCreateExceptionListItemOptions = ({
  ...
  return {
    ...
    listId: _constants.ENDPOINT_TRUSTED_APPS_LIST_ID,
    meta: undefined,
    name,
