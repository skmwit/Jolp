  ...
  return {
    ...
    queryResponseToHostListResult: searchResponse => {
      ...
      return {
        ...
        resultList: response.hits.hits.map(hit => {
          var _hit$inner_hits;

          return (_hit$inner_hits = hit.inner_hits) === null || _hit$inner_hits === void 0 ? void 0 : _hit$inner_hits.most_recent.hits.hits;
        }).flatMap(data => data).map(entry => {
          var _entry$_source;

          return (_entry$_source = entry === null || entry === void 0 ? void 0 : entry._source) !== null && _entry$_source !== void 0 ? _entry$_source : {};
        }),
