...
const config = {
  ...
  deprecations: () => [(settings, fromPath, addDeprecation) => {
    ...
    if ((taskManager === null || taskManager === void 0 ? void 0 : taskManager.max_workers) > _config.MAX_WORKERS_LIMIT) {
      addDeprecation({
        message: `setting "${fromPath}.max_workers" (${taskManager === null || taskManager === void 0 ? void 0 : taskManager.max_workers}) greater than ${_config.MAX_WORKERS_LIMIT} is deprecated. Values greater than ${_config.MAX_WORKERS_LIMIT} will not be supported starting in 8.0.`
      });
    }
