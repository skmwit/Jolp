...
function dataVisualizerRoutes({
  ...
  router.post({
    ...
    try {
      ...
      const results = await getHistogramsForFields(client, indexPatternTitle, query, fields, samplerShardSize, runtimeMappings);
      return response.ok({
        body: results
      });
    } catch (e) {
  ...
  router.post({
    ...
    try {
      ...
      const results = await getStatsForFields(client, indexPatternTitle, query, fields, samplerShardSize, timeFieldName, earliest, latest, interval, maxExamples, runtimeMappings);
      return response.ok({
        body: results
      });
    } catch (e) {
  ...
  router.post({
    ...
    try {
      ...
      const results = await getOverallStats(client, indexPatternTitle, query, aggregatableFields, nonAggregatableFields, samplerShardSize, timeFieldName, earliest, latest, runtimeMappings);
      return response.ok({
        body: results
      });
    } catch (e) {
