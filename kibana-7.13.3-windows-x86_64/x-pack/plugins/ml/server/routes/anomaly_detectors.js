...
function jobRoutes({
  ...
  router.post({
    ...
    try {
      ...
      const {
        body
      } = await mlClient.closeJob(options);
      return response.ok({
        body
      });
    } catch (e) {
  ...
  router.delete({
    ...
    try {
      ...
      const {
        body
      } = await mlClient.deleteJob(options);
      return response.ok({
        body
      });
    } catch (e) {
  ...
  router.post({
    ...
    try {
      const {
        body
      } = await mlClient.validateDetector({
        body: request.body
      });
      return response.ok({
        body
  ...
  router.post({
    ...
    try {
      const {
        body
      } = await mlClient.getOverallBuckets({
        job_id: request.params.jobId,
        body: {
  ...
  router.post({
    ...
    validate: {
      params: _anomaly_detectors_schema.getModelSnapshotsSchema,
      body: _anomaly_detectors_schema.updateModelSnapshotSchema
    },
    options: {
      tags: ['access:ml:canCreateJob']
    }
    ...
    try {
      const {
        body
      } = await mlClient.updateModelSnapshot({
        job_id: request.params.jobId,
        snapshot_id: request.params.snapshotId,
        body: request.body
      });
  ...
  router.delete({
    ...
    try {
      const {
        body
      } = await mlClient.deleteModelSnapshot({
        job_id: request.params.jobId,
        snapshot_id: request.params.snapshotId
      });
      return response.ok({
