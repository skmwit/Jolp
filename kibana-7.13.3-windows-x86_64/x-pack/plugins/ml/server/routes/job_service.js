...
function jobServiceRoutes({
  ...
  router.post({
    ...
    try {
      ...
      const {
        jobsSummary
      } = (0, _job_service.jobServiceProvider)(client, mlClient, (_context$alerting = context.alerting) === null || _context$alerting === void 0 ? void 0 : _context$alerting.getAlertsClient());
      const {
        jobIds
      } = request.body;
  ...
  router.post({
    ...
    try {
      var _context$alerting2;

      const {
        createFullJobsList
      } = (0, _job_service.jobServiceProvider)(client, mlClient, (_context$alerting2 = context.alerting) === null || _context$alerting2 === void 0 ? void 0 : _context$alerting2.getAlertsClient());
      const {
        jobIds
      } = request.body;
