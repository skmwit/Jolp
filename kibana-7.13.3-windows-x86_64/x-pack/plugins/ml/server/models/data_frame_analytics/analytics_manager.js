      ...
      if ((0, _types.isCompleteInitialReturnType)(initialData)) {
        ...
        while (complete === false) {
          ...
          if ((0, _types.isIndexPatternLinkReturnType)(link) && link.isIndexPattern === true) {
            ...
            if (link.isWildcardIndexPattern === false && (link.meta === undefined || (_link$meta = link.meta) !== null && _link$meta !== void 0 && _link$meta.created_by.includes(_common.INDEX_META_DATA_CREATED_BY))) {
