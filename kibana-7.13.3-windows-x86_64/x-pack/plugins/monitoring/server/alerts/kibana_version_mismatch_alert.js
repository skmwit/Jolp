...
class KibanaVersionMismatchAlert extends _base_alert.BaseAlert {
  ...
  async fetchData(params, esClient, clusters, availableCcs) {
    ...
    const kibanaVersions = await (0, _fetch_kibana_versions.fetchKibanaVersions)(esClient, clusters, kibanaIndexPattern, _static_globals.Globals.app.config.ui.max_bucket_size);
