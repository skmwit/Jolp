...
class LogstashVersionMismatchAlert extends _base_alert.BaseAlert {
  ...
  async fetchData(params, esClient, clusters, availableCcs) {
    ...
    const logstashVersions = await (0, _fetch_logstash_versions.fetchLogstashVersions)(esClient, clusters, logstashIndexPattern, _static_globals.Globals.app.config.ui.max_bucket_size);
