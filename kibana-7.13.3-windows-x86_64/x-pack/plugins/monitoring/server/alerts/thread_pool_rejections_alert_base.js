...
class ThreadPoolRejectionsAlertBase extends _base_alert.BaseAlert {
  ...
  async fetchData(params, esClient, clusters, availableCcs) {
    ...
    const stats = await (0, _fetch_thread_pool_rejections_stats.fetchThreadPoolRejectionStats)(esClient, clusters, esIndexPattern, _static_globals.Globals.app.config.ui.max_bucket_size, this.threadPoolType, duration);
