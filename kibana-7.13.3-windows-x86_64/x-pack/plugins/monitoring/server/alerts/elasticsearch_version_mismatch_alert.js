...
class ElasticsearchVersionMismatchAlert extends _base_alert.BaseAlert {
  ...
  async fetchData(params, esClient, clusters, availableCcs) {
    ...
    const elasticsearchVersions = await (0, _fetch_elasticsearch_versions.fetchElasticsearchVersions)(esClient, clusters, esIndexPattern, _static_globals.Globals.app.config.ui.max_bucket_size);
