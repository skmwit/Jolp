...
class CpuUsageAlert extends _base_alert.BaseAlert {
  ...
  async fetchData(params, esClient, clusters, availableCcs) {
    ...
    const stats = await (0, _fetch_cpu_usage_node_stats.fetchCpuUsageNodeStats)(esClient, clusters, esIndexPattern, startMs, endMs, _static_globals.Globals.app.config.ui.max_bucket_size);
