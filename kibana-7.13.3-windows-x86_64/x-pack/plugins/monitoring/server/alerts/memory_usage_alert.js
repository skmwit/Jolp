...
class MemoryUsageAlert extends _base_alert.BaseAlert {
  ...
  async fetchData(params, esClient, clusters, availableCcs) {
    ...
    const stats = await (0, _fetch_memory_usage_node_stats.fetchMemoryUsageNodeStats)(esClient, clusters, esIndexPattern, startMs, endMs, _static_globals.Globals.app.config.ui.max_bucket_size);
