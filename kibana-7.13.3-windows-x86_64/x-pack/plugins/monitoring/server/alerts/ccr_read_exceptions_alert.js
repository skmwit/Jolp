...
class CCRReadExceptionsAlert extends _base_alert.BaseAlert {
  ...
  async fetchData(params, esClient, clusters, availableCcs) {
    ...
    const stats = await (0, _fetch_ccr_read_exceptions.fetchCCRReadExceptions)(esClient, esIndexPattern, startMs, endMs, _static_globals.Globals.app.config.ui.max_bucket_size);
