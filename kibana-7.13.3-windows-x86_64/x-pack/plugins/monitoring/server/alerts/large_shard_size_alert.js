...
class LargeShardSizeAlert extends _base_alert.BaseAlert {
  ...
  async fetchData(params, esClient, clusters, availableCcs) {
    ...
    const stats = await (0, _fetch_index_shard_size.fetchIndexShardSize)(esClient, clusters, esIndexPattern, threshold, shardIndexPatterns, _static_globals.Globals.app.config.ui.max_bucket_size);
