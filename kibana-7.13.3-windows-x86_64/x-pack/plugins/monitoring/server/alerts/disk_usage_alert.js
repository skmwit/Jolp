...
class DiskUsageAlert extends _base_alert.BaseAlert {
  ...
  async fetchData(params, esClient, clusters, availableCcs) {
    ...
    const stats = await (0, _fetch_disk_usage_node_stats.fetchDiskUsageNodeStats)(esClient, clusters, esIndexPattern, duration, _static_globals.Globals.app.config.ui.max_bucket_size);
