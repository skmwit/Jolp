...
async function fetchThreadPoolRejectionStats(esClient, clusters, index, size, threadType, duration) {
  ...
  const stats = []; // @ts-expect-error @elastic/elasticsearch Aggregate does not specify buckets
