...
async function fetchMemoryUsageNodeStats(esClient, clusters, index, startMs, endMs, size) {
  ...
  const stats = []; // @ts-expect-error @elastic/elasticsearch Aggregate does not define buckets
