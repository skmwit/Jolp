...
function handleResponse(response, start, end) {
  ...
  const {
    ...
    const uuid = stats === null || stats === void 0 ? void 0 : (_stats$beat = stats.beat) === null || _stats$beat === void 0 ? void 0 : _stats$beat.uuid; // skip this duplicated beat, newer one was already added
    ...
    accum.ids.add(uuid); //  add the beat
    ...
    const errors = (0, _apm_stats.getDiffCalculation)(errorsWrittenLatest + errorsReadLatest, errorsWrittenEarliest + errorsReadEarliest);
    accum.beats.push({
      uuid: (_stats$beat2 = stats.beat) === null || _stats$beat2 === void 0 ? void 0 : _stats$beat2.uuid,
      name: (_stats$beat3 = stats.beat) === null || _stats$beat3 === void 0 ? void 0 : _stats$beat3.name,
      type: (0, _lodash.upperFirst)((_stats$beat4 = stats.beat) === null || _stats$beat4 === void 0 ? void 0 : _stats$beat4.type),
      ...
      errors,
      memory: (_stats$metrics6 = stats.metrics) === null || _stats$metrics6 === void 0 ? void 0 : (_stats$metrics6$beat = _stats$metrics6.beat) === null || _stats$metrics6$beat === void 0 ? void 0 : (_stats$metrics6$beat$ = _stats$metrics6$beat.memstats) === null || _stats$metrics6$beat$ === void 0 ? void 0 : _stats$metrics6$beat$.memory_alloc,
      cgroup_memory: (_hit$_source$beats_st = hit._source.beats_stats) === null || _hit$_source$beats_st === void 0 ? void 0 : (_hit$_source$beats_st2 = _hit$_source$beats_st.metrics) === null || _hit$_source$beats_st2 === void 0 ? void 0 : (_hit$_source$beats_st3 = _hit$_source$beats_st2.beat) === null || _hit$_source$beats_st3 === void 0 ? void 0 : (_hit$_source$beats_st4 = _hit$_source$beats_st3.cgroup) === null || _hit$_source$beats_st4 === void 0 ? void 0 : _hit$_source$beats_st4.memory.mem.usage.bytes,
      version: (_stats$beat5 = stats.beat) === null || _stats$beat5 === void 0 ? void 0 : _stats$beat5.version,
...
async function getApms(req, apmIndexPattern, clusterUuid) {
  ...
  const params = {
    ...
    'hits.hits._source.timestamp', 'hits.hits._source.beats_stats.beat.uuid', 'hits.hits._source.beats_stats.beat.name', 'hits.hits._source.beats_stats.beat.host', 'hits.hits._source.beats_stats.beat.type', 'hits.hits._source.beats_stats.beat.version', 'hits.hits._source.beats_stats.metrics.libbeat.output.type', 'hits.hits._source.beats_stats.metrics.libbeat.output.read.errors', 'hits.hits._source.beats_stats.metrics.libbeat.output.write.errors', 'hits.hits._source.beats_stats.metrics.beat.memstats.memory_alloc', 'hits.hits._source.beats_stats.metrics.beat.cgroup.memory.mem.usage.bytes', 'hits.hits._source.beat.stats.beat.uuid', 'hits.hits._source.beat.stats.beat.name', 'hits.hits._source.beat.stats.beat.host', 'hits.hits._source.beat.stats.beat.type', 'hits.hits._source.beat.stats.beat.version', 'hits.hits._source.beat.stats.libbeat.output.type', 'hits.hits._source.beat.stats.libbeat.output.read.errors', 'hits.hits._source.beat.stats.libbeat.output.write.errors', 'hits.hits._source.beat.stats.memstats.memory.alloc', // latest hits for calculating metrics
