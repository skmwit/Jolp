...
function _enrichStateWithStatsAggregation(stateDocument, statsAggregation, timeseriesIntervalInSeconds) {
  var _logstashState$pipeli, _logstashState$pipeli2, _logstashState$pipeli3, _logstashState$pipeli4, _statsAggregation$agg, _statsAggregation$agg2, _stateDocument$logsta;
  ...
  const verticesWithStatsBuckets = (_statsAggregation$agg = (_statsAggregation$agg2 = statsAggregation.aggregations) === null || _statsAggregation$agg2 === void 0 ? void 0 : _statsAggregation$agg2.pipelines.scoped.vertices.vertex_id.buckets) !== null && _statsAggregation$agg !== void 0 ? _statsAggregation$agg : [];
