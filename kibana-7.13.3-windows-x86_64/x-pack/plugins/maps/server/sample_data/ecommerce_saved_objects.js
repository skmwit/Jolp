...
exports.getEcommerceSavedObjects = void 0;
...
const layerList = [{
  ...
  sourceDescriptor: {
    ...
    tooltipProperties: ['category', 'customer_gender', 'manufacturer', 'order_id', 'total_quantity', 'total_unique_products', 'taxful_total_price', 'order_date', 'geoip.region_name', 'geoip.country_iso_code'],
...
const getEcommerceSavedObjects = () => {
  return [{
    ...
    attributes: {
      title: _i18n.i18n.translate('xpack.maps.sampleData.ecommerceSpec.mapsTitle', {
      ...
      bounds: {
        type: 'envelope',
        coordinates: [[-117.50707, 72.64116], [87.35497, -4.16541]]
      }
    }
  }];
};

exports.getEcommerceSavedObjects = getEcommerceSavedObjects;