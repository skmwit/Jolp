...
function defineRoutes(router, licenseState, encryptedSavedObjects) {
  (0, _legacy.defineLegacyRoutes)(router, licenseState, encryptedSavedObjects);
  (0, _create_rule.createRuleRoute)(router, licenseState);
  ...
  (0, _find_rules.findRulesRoute)(router, licenseState);
