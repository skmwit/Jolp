...
exports.muteAllAlertRoute = void 0;
...
const muteAllAlertRoute = (router, licenseState) => {
  router.post({
    path: `${_common.LEGACY_BASE_ALERT_API_PATH}/alert/{id}/_mute_all`,
    validate: {
      params: paramSchema
    }
...
exports.muteAllAlertRoute = muteAllAlertRoute;