...
exports.isSecuritySolutionRule = exports.isAnyActionSupportIncidents = exports.LEGACY_LAST_MODIFIED_VERSION = void 0;
/*
...
function getMigrations(encryptedSavedObjects) {
  ...
  const migrationSecurityRules713 = encryptedSavedObjects.createMigration(doc => isSecuritySolutionRule(doc), pipeMigrations(removeNullsFromSecurityRules));
  return {
