...
function augmentActionGroupsWithReserved(alertType) {
  ...
  if (recoveryActionGroup && activeActionGroups.has(recoveryActionGroup.id)) {
    throw new Error(_i18n.i18n.translate('xpack.alerting.alertTypeRegistry.register.customRecoveryActionGroupUsageError', {
    ...
    throw new Error(_i18n.i18n.translate('xpack.alerting.alertTypeRegistry.register.reservedActionGroupUsageError', {
