...
exports.getMetricsHostsAnomaliesRequestPayloadRT = exports.getMetricsHostsAnomaliesSuccessReponsePayloadRT = exports.INFA_ML_GET_METRICS_HOSTS_ANOMALIES_PATH = void 0;
...
const INFA_ML_GET_METRICS_HOSTS_ANOMALIES_PATH = '/api/infra/infra_ml/results/metrics_hosts_anomalies';
exports.INFA_ML_GET_METRICS_HOSTS_ANOMALIES_PATH = INFA_ML_GET_METRICS_HOSTS_ANOMALIES_PATH;
const metricsHostAnomalyCommonFieldsRT = rt.intersection([rt.type({
  id: rt.string,
...
const getMetricsHostsAnomaliesSuccessReponsePayloadRT = rt.intersection([rt.type({
...
exports.getMetricsHostsAnomaliesSuccessReponsePayloadRT = getMetricsHostsAnomaliesSuccessReponsePayloadRT;
const getMetricsHostsAnomaliesRequestPayloadRT = rt.type({
  data: rt.intersection([rt.type({
...
exports.getMetricsHostsAnomaliesRequestPayloadRT = getMetricsHostsAnomaliesRequestPayloadRT;