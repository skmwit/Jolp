...
const transformRequestToMetricsAPIRequest = async ({
  ...
  var _sourceOverrides$inde, _sourceOverrides$time;
  ...
  const metricsApiRequest = {
    ...
    timerange: {
      field: (_sourceOverrides$time = sourceOverrides === null || sourceOverrides === void 0 ? void 0 : sourceOverrides.timestamp) !== null && _sourceOverrides$time !== void 0 ? _sourceOverrides$time : source.configuration.fields.timestamp,
  ...
  if (inventoryFields.ip) {
    metaAggregation.aggregations[_constants.META_KEY].top_metrics.metrics.push({
