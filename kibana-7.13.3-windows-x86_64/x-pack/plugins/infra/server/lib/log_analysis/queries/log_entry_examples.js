...
const createLogEntryExamplesQuery = (indices, runtimeMappings, timestampField, tiebreakerField, startTime, endTime, dataset, exampleCount, categoryQuery) => ({ ..._common.defaultRequestParameters,
  body: {
    query: {
      bool: {
        filter: [{
