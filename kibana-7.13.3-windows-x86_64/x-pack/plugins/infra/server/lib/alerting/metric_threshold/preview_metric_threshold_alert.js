...
const previewMetricThresholdAlert = async ({
  ...
  try {
    const alertResults = await (0, _evaluate_alert.evaluateAlert)(esClient, params, config, timeframe);
    ...
    if ((0, _metrics.isTooManyBucketsPreviewException)(e)) {
      ...
      const currentAlertResults = !precalculatedNumberOfGroups ? await (0, _evaluate_alert.evaluateAlert)(esClient, params, config) : [];
