...
class SessionIndex {
  ...
  constructor(options) {
    ...
    _defineProperty(this, "indexName", `${this.options.kibanaIndexName}_security_session_${SESSION_INDEX_TEMPLATE_VERSION}`);

    _defineProperty(this, "indexInitialization", void 0);
  }
  /**
  ...
  async initialize() {
    ...
    return this.indexInitialization = new Promise(async (resolve, reject) => {
      ...
      try {
        indexTemplateExists = (await this.options.elasticsearchClient.indices.existsTemplate({
