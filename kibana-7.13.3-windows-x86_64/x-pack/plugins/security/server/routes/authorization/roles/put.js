...
function definePutRolesRoutes({
  ...
  router.put({
    ...
    try {
      ...
      const body = (0, _model.transformPutPayloadToElasticsearchRole)(request.body, authz.applicationName, // @ts-expect-error @elastic/elasticsearch `XPackRole` type doesn't define `applications`.
