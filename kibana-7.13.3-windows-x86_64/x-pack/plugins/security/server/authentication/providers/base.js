...
class BaseAuthenticationProvider {
  ...
  async getUser(request, authHeaders = {}) {
    return this.authenticationInfoToAuthenticatedUser( // @ts-expect-error @elastic/elasticsearch `AuthenticateResponse` type doesn't define `authentication_type` and `enabled`.
